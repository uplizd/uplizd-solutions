...
## Demo
![Sequential Tasks Agent workflow diagram showing Chat Input, Agent node, Composio Toolset, and Chat Output](assets/image.png)
...
- [CRM Data Sync Agent](../crm-data-sync-agent/index.md) - Specialized agent for multi-platform data synchronization.
- [Deal Pipeline Manager](../deal-pipeline-manager/index.md) - Orchestrates sales pipeline stages and follow-up sequences.
