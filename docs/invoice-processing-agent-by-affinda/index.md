...
## Demo
![Invoice Processing Agent workflow showing document ingestion, Affinda extraction, and CRM sync](assets/image.png)
...
- [Account Intelligence Gatherer](../account-intelligence-gatherer-by-dropcontact/index.md) - Enriches account data to ensure financial records are linked to accurate contact information.
- [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) - Manages end-to-end business process automation across multiple platforms.
