...
## Demo
![Dynamic Lead Scoring Engine workflow showing CRM data ingestion, AI scoring agent, and automated lead routing](assets/image.png)
...
- [Account Intelligence Reporter](../account-intelligence-reporter/index.md) - Gather and report on account-level insights for sales teams.
