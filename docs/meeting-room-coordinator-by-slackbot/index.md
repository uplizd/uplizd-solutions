...
## Demo
![Meeting Room Coordinator workflow showing Slack integration with calendar booking nodes](assets/image.png)
...
## Related Solutions
- [../work-hours-compliance-monitor-by-timely/README.md](../work-hours-compliance-monitor-by-timely/index.md) - Monitor and ensure adherence to team work-hour policies.
- [../workspace-usage-analyzer-by-baserow/README.md](../workspace-usage-analyzer-by-baserow/index.md) - Analyze and report on physical workspace utilization data.
- [../workshop-facilitator-agent-by-mural/README.md](../workshop-facilitator-agent-by-mural/index.md) - Automate the setup and management of collaborative workshop sessions.
