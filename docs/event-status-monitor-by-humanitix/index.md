...
## Demo
![Event Status Monitor dashboard showing real-time Humanitix ticket sales and attendee metrics](assets/image.png)
...
## 🚀 Run on Uplizd
[![Run on Uplizd](https://img.shields.io/badge/Run_on-Uplizd-blue?logo=uplizd)](https://uplizd.ai/solutions/4715dac6-6de2-542c-afc3-3a7f1a2dd8fc)
...
## Related Solutions
- [247-customer-support-assistant-by-ai-ml-api](../247-customer-support-assistant-by-ai-ml-api/index.md) - Automated support workflows for event attendees.
- [workflow-health-monitor-by-dailybot](../workflow-health-monitor-by-dailybot/index.md) - Broader operational monitoring for team workflows.
- [account-health-usage-monitor-by-jotform](../account-health-usage-monitor-by-jotform/index.md) - Tracking usage and health metrics for registered accounts.
