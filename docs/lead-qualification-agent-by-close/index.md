...
## Demo
![Lead Qualification Agent workflow showing Chat Input, Agent node, Close CRM toolset, and Chat Output](assets/image.png)
...
## Related Solutions
- [../account-research-agent-by-onepage/README.md](../account-research-agent-by-onepage/index.md) — Research and gather intelligence on target accounts.
- [../account-setup-agent-by-salesforce/README.md](../account-setup-agent-by-salesforce/index.md) — Automate the creation and configuration of new accounts in Salesforce.
- [../crm-data-sync-agent/README.md](../crm-data-sync-agent/index.md) — Synchronize data across multiple CRM platforms to ensure a single source of truth.
