...
## Demo
![Contract Automation Agent workflow showing data ingestion from CRM to DocuPilot](assets/image.png)
...
## Related Solutions
* [Account Research Agent](../account-research-agent-by-onepage/index.md) — Automates deep-dive research on prospective accounts.
* [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) — Streamlines the creation of new accounts and records in Salesforce.
