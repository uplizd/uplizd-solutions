...
## Demo
![Customer Health Monitor workflow dashboard showing Gorgias support ticket trends and sentiment analysis](assets/image.png)
...
## Related Solutions
* [247 Customer Support Assistant](../247-customer-support-assistant-by-ai-ml-api/index.md) - Automate routine support inquiries and ticket triage.
* [Account Health Usage Monitor](../account-health-usage-monitor-by-jotform/index.md) - Track product usage metrics to supplement support data.
* [Account Intelligence Reporter](../account-intelligence-reporter-by-leadfeeder/index.md) - Enrich account profiles with external intent and firmographic data.
