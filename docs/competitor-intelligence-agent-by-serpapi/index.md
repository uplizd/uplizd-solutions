...
## Demo
![Competitor Intelligence Agent workflow dashboard showing SerpApi search nodes and data analysis pipeline](assets/image.png)
...
- [Account Research Assistant](../account-research-assistant-by-zoominfo/index.md) - Deep-dive research into target accounts using ZoomInfo data.
- [YouTube Competitor Intelligence Agent](../you-tube-competitor-intelligence-agent-by-youtube/index.md) - Monitor and analyze competitor video content performance.
