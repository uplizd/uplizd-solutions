...
## Demo
![Proposal Housekeeping Agent workflow interface showing Bidsketch integration nodes](assets/image.png)
...
## Related Solutions
* [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) - Automate new client onboarding and CRM record creation.
* [Action Item Cleanup Agent](../action-item-cleanup-agent-by-rootly/index.md) - Maintain organized task lists and resolve stale action items.
* [CRM Data Hygiene Manager](../crm-data-hygiene-manager/index.md) - Comprehensive tools for cleaning and formatting CRM contact data.
