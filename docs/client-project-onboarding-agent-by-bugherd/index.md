...
## Demo
![Client Project Onboarding Agent workflow diagram showing BugHerd integration for automated project setup and task creation](assets/image.png)
...
- [Workflow Automation Agent (JobNimbus)](../workflow-automation-agent-by-jobnimbus/index.md) - Streamline business processes and task tracking.
- [Admin User Onboarding Assistant (Storeganise)](../admin-user-onboarding-assistant-by-storeganise/index.md) - Manage user access and administrative onboarding.
