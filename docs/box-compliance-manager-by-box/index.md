...
## Demo
![Box Compliance Manager workflow showing automated file classification and legal hold triggers in the Uplizd builder](assets/image.png)
...
- [../accessibility-compliance-monitor-by-alttext-ai/README.md](../accessibility-compliance-monitor-by-alttext-ai/index.md) - Automate accessibility compliance monitoring.
- [../admin-user-access-auditor-by-storeganise/README.md](../admin-user-access-auditor-by-storeganise/index.md) - Audit user access and permissions across platforms.
