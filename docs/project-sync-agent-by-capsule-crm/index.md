...
## Demo
![Project Sync Agent workflow diagram showing Chat Input, Agent node, Composio Toolset, and Chat Output](assets/image.png)
...
* [CRM Data Hygiene Manager](../crm-data-hygiene-manager/index.md) — Automate data cleanup and formatting for CRM records.
