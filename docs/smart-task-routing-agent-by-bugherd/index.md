...
## Demo
![Smart Task Routing Agent workflow diagram showing BugHerd integration and AI-driven assignment](assets/image.png)
...
## Related Solutions
- [Action Item Prioritizer](../action-item-prioritizer-by-rootly/index.md) — Automatically rank and prioritize incoming tasks and action items.
- [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) — General purpose automation for streamlining complex business workflows.
- [Account Research Agent](../account-research-agent-by-onepage/index.md) — Gather and synthesize account intelligence to inform task routing decisions.
