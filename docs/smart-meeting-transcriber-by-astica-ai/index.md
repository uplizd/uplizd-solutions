...
## Demo
![Smart Meeting Transcriber workflow showing audio input processing through Astica AI and Composio Toolset to generate structured meeting transcripts](assets/image.png)
...
## Related Solutions
- [247-customer-support-voice-agent-by-bolna](../247-customer-support-voice-agent-by-bolna/index.md) - Manage voice-based customer support interactions.
- [action-item-prioritizer-by-rootly](../action-item-prioritizer-by-rootly/index.md) - Organize and prioritize tasks extracted from meetings.
- [account-research-assistant-by-zoominfo](../account-research-assistant-by-zoominfo/index.md) - Enrich account data using insights gathered from client calls.
