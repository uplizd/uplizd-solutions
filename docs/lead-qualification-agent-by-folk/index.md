...
## Demo
![Lead Qualification Agent workflow showing Chat Input, AI Agent, Folk CRM integration, and Chat Output nodes](assets/image.png)
...
- [Account Research Agent](../account-research-agent-by-onepage/index.md) — Automate research tasks for target accounts.
- [CRM Data Sync Agent](../crm-data-sync-agent/index.md) — Maintain synchronization across multiple CRM platforms.
