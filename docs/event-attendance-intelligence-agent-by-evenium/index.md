...
## Demo
![Event Attendance Intelligence Agent dashboard showing real-time attendee tracking and engagement metrics](assets/image.png)
...
- [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) - Automate the creation and configuration of new CRM accounts.
