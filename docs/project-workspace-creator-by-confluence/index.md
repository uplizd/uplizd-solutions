...
## Demo
![Project Workspace Creator workflow showing automated Confluence page generation and template application](assets/image.png)
...
## Related Solutions
* [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) - Automate CRM account provisioning and data entry.
...
* [Workshop Template Curator](../workshop-template-curator-by-miro/index.md) - Manage and deploy collaborative workshop templates for remote teams.
