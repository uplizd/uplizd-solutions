...
## Demo
![Apollo Pipeline Stage Automation workflow interface showing automated deal movement triggers](assets/image.png)
...
* [Deal Pipeline Manager](../deal-pipeline-manager/index.md) - Comprehensive management of pipeline stages and follow-up cadences.
