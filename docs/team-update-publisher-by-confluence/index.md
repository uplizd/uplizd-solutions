...
## Demo
![Team Update Publisher workflow showing Chat Input, Agent, Confluence integration, and Chat Output](assets/image.png)
...
## Related Solutions
* [Workshop Template Curator](../workshop-template-curator-by-miro/index.md) - Manage and deploy collaborative workshop templates.
* [Workflow Health Monitor](../workflow-health-monitor-by-dailybot/index.md) - Track and report on team workflow efficiency.
* [Account Intelligence Reporter](../account-intelligence-reporter-by-leadfeeder/index.md) - Generate and distribute account insights to sales teams.
