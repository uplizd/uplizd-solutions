...
## Demo
![Project Onboarding Automator workflow showing automated board creation and team assignment in Monday.com](assets/image.png)
...
- [Workflow Automation Agent (JobNimbus)](../workflow-automation-agent-by-jobnimbus/index.md) — Streamline job tracking and task assignments.
- [Workforce Onboarding Automator (Connecteam)](../workforce-onboarding-automator-by-connecteam/index.md) — Manage new employee onboarding and team integration.
