...
## Demo
![Competitor Price Monitor workflow dashboard showing automated scraping nodes and alert triggers](assets/image.png)
...
## 🚀 Run on Uplizd
[![Run on Uplizd](https://img.shields.io/badge/Run_on_Uplizd-blue?logo=uplizd)](https://uplizd.ai/solutions/39ab68b7-7d26-50ce-88fa-fea94a1baf0f)
...
## Related Solutions
- [Account Intelligence Gatherer](../account-intelligence-gatherer-by-dropcontact/index.md) — Enrich account data to better understand your competitive landscape.
- [Ad Trend Tracking Agent](../ad-trend-tracking-agent-by-adyntel/index.md) — Monitor competitor advertising trends alongside your pricing data.
- [Account Research Agent](../account-research-agent-by-onepage/index.md) — Deep dive into competitor business profiles and market positioning.
