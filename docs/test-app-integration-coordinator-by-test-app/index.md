...
## Demo
![Uplizd workflow diagram showing the Test App Integration Coordinator connecting Chat Input to external systems via the Composio Toolset](assets/image.png)
...
## Related Solutions
- [Account Research Agent](../account-research-agent-by-onepage/index.md) - Automate deep-dive research into accounts and prospects.
...
- [CRM Data Sync Agent](../crm-data-sync-agent/index.md) - Maintain consistent data across your CRM and secondary tools.
