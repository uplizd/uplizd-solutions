...
## Demo
![Job Market Intelligence Agent dashboard showing real-time job posting trends and salary distribution analysis](assets/image.png)
...
*   [Account Research Agent](../account-research-agent-by-onepage/index.md) - Automate deep-dive research into target accounts and company profiles.
