...
## Demo
![Event Follow-Up Card Agent workflow showing lead data processing and card dispatch](assets/image.png)
...
## Related Solutions
- [Account Research Assistant](../account-research-assistant-by-zoominfo/index.md) - Gather deep intelligence on prospects before sending follow-ups.
- [CRM Data Sync Agent](../crm-data-sync-agent/index.md) - Keep your lead data consistent across multiple platforms during event cycles.
- [Deal Pipeline Manager](../deal-pipeline-manager/index.md) - Move leads through your sales funnel after the initial follow-up is sent.
