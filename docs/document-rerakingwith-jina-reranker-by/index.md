...
## Demo
![Document Reranking workflow showing vector retrieval, Jina Reranker processing, and final output](assets/image.png)
...
- [Academic Writing Precision Assistant](../academic-writing-precision-assistant-by-dictionary-api/index.md) - Enhance document quality and linguistic accuracy.
- [YouTube Insight Agent](../you-tube-insight-agent-by/index.md) - Extract and rank insights from video content metadata.
