...
## Demo
![Relationship Mapping Agent workflow visualizing connections between contacts and companies in Folk CRM](assets/image.png)
...
## Related Solutions
- [Account Research Agent](../account-research-agent-by-onepage/index.md) - Automates deep-dive research into target accounts and prospect profiles.
- [Account Relationship Builder](../account-relationship-builder-by-dynamics365/index.md) - Synchronizes relationship data across Dynamics 365 environments.
- [Deal Pipeline Manager](../deal-pipeline-manager/index.md) - Tracks and manages sales stages to improve overall pipeline health.
