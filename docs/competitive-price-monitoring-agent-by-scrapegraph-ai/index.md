...
## Demo
![Competitive Price Monitoring Agent dashboard showing real-time price extraction from competitor websites and automated reporting](assets/image.png)
...
## 🚀 Run on Uplizd
[![Run on Uplizd](https://img.shields.io/badge/Run_on-Uplizd-blue?logo=uplizd)](https://uplizd.ai/solutions/183ad8b2-f915-5a61-a65c-c8cf3b374e16)
...
## Related Solutions
- [Account Intelligence Reporter](../account-intelligence-reporter-by-leadfeeder/index.md) — Automate the gathering of company-level insights and lead data.
- [Account Research Agent](../account-research-agent-by-onepage/index.md) — Deep-dive research into prospect accounts to improve sales outreach.
- [Deal Opportunity Tracker](../deal-opportunity-tracker-by-salesforce/index.md) — Identify and score new sales opportunities based on market signals.
