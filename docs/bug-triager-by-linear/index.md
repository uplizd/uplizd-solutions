...
## Demo
![Bug Triager workflow dashboard showing automated ticket categorization and Linear integration](assets/image.png)
...
## Related Solutions
* [Action Item Prioritizer (Rootly)](../action-item-prioritizer-by-rootly/index.md) - Automates the prioritization of incoming action items and tasks.
* [Action Item Cleanup Agent (Rootly)](../action-item-cleanup-agent-by-rootly/index.md) - Maintains hygiene by cleaning up stale or resolved action items.
* [Workflow Health Monitor (DailyBot)](../workflow-health-monitor-by-dailybot/index.md) - Tracks the efficiency and health of your team's development workflows.
