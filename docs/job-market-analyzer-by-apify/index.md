...
## Demo
![Job Market Analyzer dashboard showing real-time salary trends and job posting volume across multiple sectors](assets/image.png)
...
- [Account Research Agent](../account-research-agent-by-onepage/index.md) - Automate deep-dive research into target prospect accounts.
