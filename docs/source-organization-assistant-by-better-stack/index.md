...
## Demo
![Source Organization Assistant dashboard showing automated log categorization and monitoring source health status](assets/image.png)
...
## Related Solutions
- [Workflow Health Monitor](../workflow-health-monitor-by-dailybot/index.md) — Tracks the operational status and health of automated workflows.
...
- [Action Item Cleanup Agent](../action-item-cleanup-agent-by-rootly/index.md) — Automates the organization and resolution of pending action items and tasks.
