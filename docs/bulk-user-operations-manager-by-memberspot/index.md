...
## Demo
![Bulk User Operations Manager dashboard showing batch processing status and user status updates](assets/image.png)
...
- [Admin User Onboarding Assistant](../admin-user-onboarding-assistant-by-storeganise/index.md) — Streamline the automated onboarding process for new users.
- [CRM Data Hygiene Manager](../crm-data-hygiene-manager/index.md) — Maintain clean CRM data through automated cleanup and formatting.
