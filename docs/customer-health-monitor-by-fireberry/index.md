...
## Demo
![Customer Health Monitor dashboard showing real-time churn risk scores and account engagement metrics](assets/image.png)
...
## Related Solutions
- [Account Research Agent](../account-research-agent-by-onepage/index.md) — Automates deep-dive research into account background and firmographics.
- [CRM Data Sync Agent](../crm-data-sync-agent/index.md) — Ensures consistent data across multiple CRM and support platforms.
- [Deal Pipeline Manager](../deal-pipeline-manager/index.md) — Tracks sales stages and manages follow-up workflows for active opportunities.
