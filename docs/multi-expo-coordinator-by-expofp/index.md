...
## Demo
![Multi-Expo Coordinator workflow diagram showing Chat Input, Agent, Composio Toolset, and Chat Output nodes](assets/image.png)
...
## Related Solutions
- [Account Setup Agent by Salesforce](../account-setup-agent-by-salesforce/index.md) - Automates CRM account configuration and data mapping.
- [Workflow Automation Agent by Jobnimbus](../workflow-automation-agent-by-jobnimbus/index.md) - Streamlines operational workflows across project management platforms.
- [Workshop Template Curator by Miro](../workshop-template-curator-by-miro/index.md) - Manages and standardizes templates for collaborative event planning.
