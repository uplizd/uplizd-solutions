...
## Demo
![Document Digitizer Agent workflow showing OCR processing and data extraction](assets/image.png)
...
## 🚀 Run on Uplizd
[![Run on Uplizd](https://img.shields.io/badge/Run_on-Uplizd-blue?logo=uplizd)](https://uplizd.ai/solutions/9d2a935e-97cd-5b9b-b6ea-fe7c226c6e92)
...
- [CRM Data Hygiene Manager](../crm-data-hygiene-manager/index.md) - Cleanse and format your database to ensure high-quality records.
- [Account Research Agent](../account-research-agent/index.md) - Automatically gather and summarize intelligence on target accounts.
