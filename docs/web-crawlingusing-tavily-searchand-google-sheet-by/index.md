...
## Demo
![Web Crawling and Google Sheets integration workflow diagram showing Tavily search results being parsed and saved to a spreadsheet](assets/image.png)
...
- [CRM Data Sync Agent](../crm-data-sync-agent/index.md) - Synchronize data across multiple platforms and CRM systems.
- [Deal Opportunity Tracker](../deal-opportunity-tracker-by-salesforce/index.md) - Track and score sales opportunities using automated signals.
