...
## Demo
![Podcast Trend Tracker workflow dashboard showing real-time topic analysis and trend alerts](assets/image.png)
...
- [Account Intelligence Reporter](../account-intelligence-reporter-by-leadfeeder/index.md) — Gather and report on account-level market intelligence.
- [Ad Trend Tracking Agent](../ad-trend-tracking-agent-by-adyntel/index.md) — Monitor and analyze advertising trends across digital platforms.
