...
## Demo
![Investment Research Analyst workflow dashboard showing stock data extraction and analyst consensus reporting](assets/image.png)
...
## Related Solutions
- [Account Research Agent](../account-research-agent-by-onepage/index.md) — Deep-dive intelligence gathering for corporate accounts.
- [Account Intelligence Reporter](../account-intelligence-reporter-by-leadfeeder/index.md) — Automated reporting for lead and account insights.
- [Academic Impact Tracker](../academic-impact-tracker-by-semanticscholar/index.md) — Research-focused data aggregation and impact analysis.
