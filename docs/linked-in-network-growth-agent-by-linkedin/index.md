...
## Demo
![LinkedIn Network Growth Agent workflow interface showing automated connection and messaging steps](assets/image.png)
...
- [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) - Automated CRM record creation and onboarding.
- [Deal Pipeline Manager](../deal-pipeline-manager/index.md) - Manage and track deal stages through the sales cycle.
