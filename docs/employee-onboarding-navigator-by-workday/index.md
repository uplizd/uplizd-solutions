...
## Demo
![Employee Onboarding Navigator workflow showing Chat Input, Agent, Workday Composio Toolset, and Chat Output nodes](assets/image.png)
...
## Related Solutions
- [Workforce Onboarding Automator](../workforce-onboarding-automator-by-connecteam/index.md) - Streamline general workforce onboarding and task management.
- [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) - Automate account provisioning and configuration workflows.
- [Admin User Onboarding Assistant](../admin-user-onboarding-assistant-by-storeganise/index.md) - Manage administrative access and user setup processes.
