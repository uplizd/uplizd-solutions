...
## Demo
![Document Processing Agent workflow showing file ingestion, conversion, and data extraction nodes](assets/image.png)
...
* [Action Item Cleanup Agent](../action-item-cleanup-agent-by-rootly/index.md) - Process and organize tasks extracted from meeting documents.
