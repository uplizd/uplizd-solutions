...
## Demo
![Automated Invoice Processor workflow diagram showing project data input, Elorus invoice generation, and automated delivery](assets/image.png)
...
- [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) - Streamline end-to-end project and task management workflows.
- [Account Relationship Builder](../account-relationship-builder-by-dynamics365/index.md) - Manage client data and relationship health across platforms.
