...
## Demo
![GDPR Meeting Data Manager workflow showing automated Calendly data deletion request processing](assets/image.png)
...
## Related Solutions
* [Account Health Compliance Monitor](../account-health-compliance-monitor-by-brevo/index.md) - Monitor and maintain compliance across account health metrics.
* [Action Item Cleanup Agent](../action-item-cleanup-agent-by-rootly/index.md) - Automate the removal of stale action items and tasks.
* [Admin User Access Auditor](../admin-user-access-auditor-by-storeganise/index.md) - Audit and manage user access permissions for compliance.
