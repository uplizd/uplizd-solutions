...
## Demo
![Lead Email Validator workflow showing Chat Input, Agent, Composio Toolset, and Chat Output nodes](assets/image.png)
...
*   [Lead Qualification Agent](../whats-app-lead-qualification-agent-by-whatsapp/index.md) — Qualify leads across messaging channels.
