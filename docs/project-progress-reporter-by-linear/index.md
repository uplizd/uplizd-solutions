...
## Demo
![Project Progress Reporter workflow dashboard showing Linear data integration and automated report generation](assets/image.png)
...
- [Account Mapping Agent](../account-mapping-agent-by-bigpicture-io/index.md) - Visualize complex project dependencies and account structures.
- [Action Item Prioritizer](../action-item-prioritizer-by-rootly/index.md) - Automatically rank and assign tasks based on project urgency.
