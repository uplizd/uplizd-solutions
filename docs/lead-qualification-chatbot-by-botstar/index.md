...
## Demo
![Lead Qualification Chatbot workflow interface showing conversational AI screening and CRM routing](assets/image.png)
...
- [Deal Pipeline Manager](../deal-pipeline-manager/index.md) - Manage and track deal stages to improve sales conversion.
- [247 Customer Support Chatbot](../247-customer-support-chatbot-by-botstar/index.md) - Provide automated, round-the-clock support for your customers.
