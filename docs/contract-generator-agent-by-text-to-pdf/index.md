...
## Demo
![Contract Generator Agent workflow diagram showing text input, AI processing, and PDF export](assets/image.png)
...
## Related Solutions
* [Account Research Agent](../account-research-agent-by-onepage/index.md) - Gather deep intelligence on prospects to inform contract terms.
* [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) - Automate the provisioning of new client accounts in your CRM.
* [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) - Connect document generation to broader business process triggers.
