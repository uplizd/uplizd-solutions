...
## Demo
![Instagram Content Scheduler dashboard showing automated post queue and AI-generated caption suggestions](assets/image.png)
...
- [WhatsApp Lead Nurturing Agent](../whats-app-lead-nurturing-agent-by-spoki/index.md) — Engage leads directly via automated messaging workflows.
- [Affiliate Program Analytics Agent](../affiliate-program-analytics-agent-by-tapfiliate/index.md) — Track and optimize performance metrics for marketing partnerships.
