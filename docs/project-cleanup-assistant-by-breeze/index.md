...
## Demo
![Project Cleanup Assistant workflow interface showing automated archiving logic](assets/image.png)
...
## Related Solutions
* [Action Item Cleanup Agent](../action-item-cleanup-agent-by-rootly/index.md) - Automates the identification and resolution of stale action items.
* [Workflow Health Monitor](../workflow-health-monitor-by-dailybot/index.md) - Tracks the efficiency and status of team workflows.
* [Account Health Usage Monitor](../account-health-usage-monitor-by-jotform/index.md) - Monitors account activity and usage patterns for better data management.
