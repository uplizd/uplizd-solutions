...
## Demo
![Automated Call Recording Ingestion workflow diagram showing file source to Gong integration](assets/image.png)
...
## Related Solutions
- [Deal Pipeline Manager](../deal-pipeline-manager/index.md) - Manage sales stages and track deal velocity.
