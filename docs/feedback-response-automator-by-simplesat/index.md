...
## Demo
![Feedback Response Automator workflow showing Chat Input, Agent, Composio Toolset, and Chat Output nodes](assets/image.png)
...
- [whats-app-feedback-collection-agent-by-wati](../whats-app-feedback-collection-agent-by-wati/index.md) — Automated feedback collection via WhatsApp for mobile-first engagement.
- [account-health-usage-monitor-by-jotform](../account-health-usage-monitor-by-jotform/index.md) — Monitor account health and usage metrics to proactively manage customer success.
