...
## Demo
![Intelligent Lead Nurturing Agent workflow diagram showing lead input, AI analysis, and automated CRM outreach](assets/image.png)
...
- [Deal Pipeline Manager](../deal-pipeline-manager/index.md) - Manage and track deal stages to improve sales velocity.
- [Account Research Agent](../account-research-agent/index.md) - Automate deep-dive research on target accounts before outreach.
