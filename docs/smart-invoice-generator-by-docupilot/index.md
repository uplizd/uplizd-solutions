...
## Demo
![Smart Invoice Generator workflow showing data flow from CRM to Docupilot for automated billing](assets/image.png)
...
* [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) - Manage end-to-end project and task automation.
