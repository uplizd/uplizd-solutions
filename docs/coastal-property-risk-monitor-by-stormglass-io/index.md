...
## Demo
![Coastal Property Risk Monitor workflow dashboard showing real-time weather and tide data integration](assets/image.png)
...
## 🚀 Run on Uplizd
[![](https://img.shields.io/badge/Run_on-Uplizd-blue)](https://uplizd.ai/solutions/ba7cbaa8-d762-55a6-ac5d-383c813dfe1c)
...
## Related Solutions
* [Workplace Risk Early Warning System](../workplace-risk-early-warning-system-by-faceup/index.md) - Monitor and mitigate general workplace safety risks.
* [Account Health Usage Monitor](../account-health-usage-monitor-by-jotform/index.md) - Track and report on account-level operational metrics.
* [Workflow Health Monitor](../workflow-health-monitor-by-dailybot/index.md) - Ensure the reliability and uptime of your automated business processes.
