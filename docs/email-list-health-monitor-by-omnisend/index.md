...
## Demo
![Email List Health Monitor workflow dashboard showing automated subscriber segmentation and cleanup status](assets/image.png)
...
## Related Solutions
- [Abandoned Cart Recovery Agent](../abandoned-cart-recovery-agent-by-klaviyo/index.md) - Automate recovery sequences for high-intent e-commerce shoppers.
...
- [CRM Data Hygiene Manager](../crm-data-hygiene-manager/index.md) - Maintain overall CRM data integrity and formatting.
