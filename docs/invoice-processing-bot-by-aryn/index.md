...
## Demo
![Invoice Processing Bot workflow diagram showing document ingestion, AI extraction, and system sync](assets/image.png)
...
* [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) — Streamline the creation of new accounts and vendor profiles.
* [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) — General purpose automation for complex business process flows.
