...
## Demo
![Training Session Coordinator workflow interface showing ClickMeeting integration nodes and automated participant scheduling](assets/image.png)
...
## Related Solutions
- [Workshop Facilitator Agent (Mural)](../workshop-facilitator-agent-by-mural/index.md) — Automate collaborative workshop setup and board management.
- [Workshop Template Curator (Miro)](../workshop-template-curator-by-miro/index.md) — Streamline the selection and deployment of workshop templates.
- [Workforce Onboarding Automator](../workforce-onboarding-automator/index.md) — End-to-end automation for new hire workflows and system provisioning.
