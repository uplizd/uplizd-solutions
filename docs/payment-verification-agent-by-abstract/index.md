...
## Demo
![Payment Verification Agent workflow interface showing IBAN validation and transaction status nodes](assets/image.png)
...
- [Account Research Agent](../account-research-agent-by-onepage/index.md) - Gathers and verifies company intelligence for B2B sales and finance.
- [CRM Data Hygiene Manager](../crm-data-hygiene-manager/index.md) - Maintains overall database health and removes duplicate or decayed records.
