...
## Demo
![Automated Course Creator workflow interface showing AI-driven module generation and D2L Brightspace integration](assets/image.png)
...
## Related Solutions
- [Adaptive Learning Curriculum Builder](../adaptive-learning-curriculum-builder-by-perplexityai/index.md) - AI-driven personalized learning path generation.
...
- [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) - General-purpose automation for complex operational workflows.
