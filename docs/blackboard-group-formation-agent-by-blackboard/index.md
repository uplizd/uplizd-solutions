...
## Demo
![Blackboard Group Formation Agent workflow screenshot showing student data processing and group assignment logic](assets/image.png)
...
## Related Solutions
- [Workshop Facilitator Agent](../workshop-facilitator-agent-by-mural/index.md) — Manage collaborative workshop logistics and participant engagement.
- [Academic Impact Tracker](../academic-impact-tracker-by-semanticscholar/index.md) — Monitor and analyze research output and academic citations.
- [Adaptive Learning Curriculum Builder](../adaptive-learning-curriculum-builder-by-perplexityai/index.md) — Create personalized learning paths for students based on performance data.
