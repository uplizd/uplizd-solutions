...
## Demo
![NFT Market Intelligence Agent dashboard showing real-time floor price tracking and collection volume analysis](assets/image.png)
...
## Related Solutions
* [Account Intelligence Gatherer](../account-intelligence-gatherer-by-dropcontact/index.md) — Enrich account data for better sales targeting.
* [Account Intelligence Reporter](../account-intelligence-reporter-by-leadfeeder/index.md) — Generate detailed reports on account engagement and intent.
* [YouTube Competitor Intelligence Agent](../you-tube-competitor-intelligence-agent-by-youtube/index.md) — Track competitor performance and content trends.
