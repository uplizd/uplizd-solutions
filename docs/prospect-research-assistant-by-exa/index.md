...
## Demo
![Prospect Research Assistant workflow showing Chat Input, Exa Search Agent, and structured output](assets/image.png)
...
## Related Solutions
- [Account Research Agent](../account-research-agent-by-onepage/index.md) — Targeted deep-dive research for specific account profiles.
- [Account Intelligence Reporter](../account-intelligence-reporter-by-leadfeeder/index.md) — Automated reporting on account activity and intent signals.
- [Account Intelligence Gatherer](../account-intelligence-gatherer-by-dropcontact/index.md) — Enrichment of account data with contact-level details.
