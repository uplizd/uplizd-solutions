...
## Demo
![WhatsApp Appointment Scheduler workflow interface showing chat input, agent processing, and calendar confirmation](assets/image.png)
...
## Related Solutions
- [WhatsApp Lead Qualifier (WATI)](../whats-app-lead-qualifier-by-wati/index.md) - Qualify incoming leads directly through WhatsApp conversations.
- [WhatsApp Order Status Agent (WATI)](../whats-app-order-status-agent-by-wati/index.md) - Provide real-time order tracking updates via WhatsApp.
- [WhatsApp Support Triage Agent (WATI)](../whats-app-support-triage-agent-by-wati/index.md) - Automatically categorize and route incoming support tickets.
