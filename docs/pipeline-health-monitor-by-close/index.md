...
## Demo
![Pipeline Health Monitor dashboard showing stalled deal alerts and automated task creation workflows](assets/image.png)
...
## Related Solutions
* [Deal Pipeline Manager](../deal-pipeline-manager/index.md) — Manage pipeline stages and follow-up sequences.
* [Deal Opportunity Tracker](../deal-opportunity-tracker/index.md) — Identify and score new sales opportunities.
* [CRM Data Hygiene Manager](../crm-data-hygiene-manager/index.md) — Clean up and maintain CRM data integrity.
