...
## Demo
![Crypto Research Assistant dashboard showing real-time token price trends and market sentiment analysis](assets/image.png)
...
- [Account Intelligence Reporter](../account-intelligence-reporter-by-leadfeeder/index.md) — Aggregates lead intelligence to improve sales pipeline quality.
- [Academic Impact Tracker](../academic-impact-tracker-by-semanticscholar/index.md) — Monitors research trends and publication metrics for academic analysis.
