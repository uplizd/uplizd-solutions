...
## Demo
![Payment Link Generator workflow showing Chat Input, Agent, Flutterwave Composio Toolset, and Chat Output](assets/image.png)
...
- [Affiliate Payment Automation Agent](../affiliate-payment-automation-agent-by-tapfiliate/index.md) - Streamline partner payouts and commission tracking.
- [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) - Manage end-to-end business process automation.
