...
## Demo
![Social Media Agent workflow interface showing Apify Actor integration and data extraction nodes](assets/image.png)
...
- [YouTube Audience Research Agent](../you-tube-audience-research-agent-by-youtube/index.md) - Analyze audience demographics and engagement on YouTube.
- [CRM Data Sync Agent](../crm-data-sync-agent/index.md) - Synchronize enriched social data across your CRM platforms.
