...
## Demo
![Smart Meeting Scheduler workflow interface showing natural language scheduling prompts and Microsoft Teams integration](assets/image.png)
...
## Related Solutions
* [Account Relationship Builder](../account-relationship-builder-by-dynamics365/index.md) — Manage and nurture complex account relationships within Dynamics 365.
* [Account Research Agent](../account-research-agent-by-onepage/index.md) — Automate deep-dive research on prospects to prepare for scheduled meetings.
* [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) — Streamline end-to-end business processes and task management.
