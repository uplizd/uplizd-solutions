...
## Demo
![Market Research Agent workflow interface showing automated data extraction and structured output generation](assets/image.png)
...
## Related Solutions
- [Account Research Agent](../account-research-agent-by-onepage/index.md) — Deep-dive research and intelligence gathering for specific accounts.
...
- [YouTube Competitor Intelligence Agent](../you-tube-competitor-intelligence-agent-by-youtube/index.md) — Analyzing competitor video content and market presence.
