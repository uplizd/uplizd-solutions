...
## Demo
![Customer Onboarding Automation Agent workflow showing CRM data flowing into Rocketlane project templates via Uplizd](assets/image.png)
...
## Related Solutions
*   [Account Setup Agent (Salesforce)](../account-setup-agent-by-salesforce/index.md) — Automates CRM account provisioning and field population.
*   [Deal Pipeline Manager](../deal-pipeline-manager/index.md) — Manages deal stages and pipeline velocity for sales teams.
*   [CRM Data Sync Agent](../crm-data-sync-agent/index.md) — Ensures consistent data synchronization across multiple platforms.
*   [Account Relationship Builder (Dynamics 365)](../account-relationship-builder-by-dynamics365/index.md) — Strengthens client relationships through automated engagement tracking.
