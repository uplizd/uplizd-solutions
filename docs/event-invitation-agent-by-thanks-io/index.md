...
## Demo
![Event Invitation Agent workflow showing the integration between Chat Input, AI Agent, and Thanks.io for automated mailing](assets/image.png)
...
## Related Solutions
- [Account Research Assistant](../account-research-assistant-by-zoominfo/index.md) — Gather deep intelligence on prospects before sending invitations.
- [CRM Data Hygiene Manager](../crm-data-hygiene-manager/index.md) — Ensure your guest list data is clean and accurate before triggering mailers.
- [WhatsApp Lead Nurturing Agent](../whats-app-lead-nurturing-agent-by-spoki/index.md) — Complement physical mailers with digital follow-ups on WhatsApp.
