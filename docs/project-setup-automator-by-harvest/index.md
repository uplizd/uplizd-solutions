...
## Demo
![Project Setup Automator workflow interface showing automated task creation and team assignment in Harvest](assets/image.png)
...
* [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) — Automate complex project workflows and status updates.
* [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) — Standardize account provisioning and CRM data entry.
