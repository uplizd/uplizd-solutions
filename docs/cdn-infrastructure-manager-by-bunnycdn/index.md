...
## Demo
![CDN Infrastructure Manager dashboard showing automated edge rule deployment and cache status monitoring](assets/image.png)
...
## Related Solutions
- [Zone Provisioning Agent](../zone-provisioning-agent-by-cloudflare/index.md) - Automate infrastructure provisioning using Cloudflare.
