...
## Demo
![Fundraising Event Coordinator workflow interface showing Givebutter integration nodes](assets/image.png)
...
## Related Solutions
- [Account Relationship Builder](../account-relationship-builder-by-dynamics365/index.md) - Manage complex donor and account hierarchies.
- [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) - General purpose automation for operational tasks.
- [Account Research Agent](../account-research-agent-by-onepage/index.md) - Deep dive into donor profiles and background information.
