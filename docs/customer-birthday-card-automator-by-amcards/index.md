...
## Demo
![Customer Birthday Card Automator workflow showing CRM data integration with Amcards for automated greeting delivery](assets/image.png)
...
## Related Solutions
- [Abandoned Cart Recovery Agent](../abandoned-cart-recovery-agent-by-klaviyo/index.md) - Recovers lost revenue through automated follow-up sequences.
- [Account Intelligence Gatherer](../account-intelligence-gatherer-by-dropcontact/index.md) - Enriches CRM data to provide deeper insights into customer profiles.
- [WhatsApp Lead Nurturing Agent](../whats-app-lead-nurturing-agent-by-spoki/index.md) - Engages leads through automated, personalized messaging on WhatsApp.
