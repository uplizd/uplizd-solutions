...
## Demo
![Customer Onboarding Orchestrator workflow showing automated task creation and status tracking in Workiom](assets/image.png)
...
## Related Solutions
* [Account Setup Agent (Salesforce)](../account-setup-agent-by-salesforce/index.md) - Automate initial account configuration and data entry.
* [Workforce Onboarding Automator](../workforce-onboarding-automator-by-connecteam/index.md) - Streamline internal employee onboarding and documentation.
