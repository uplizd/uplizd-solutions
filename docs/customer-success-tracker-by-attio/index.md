...
## Demo
![Customer Success Tracker workflow showing Attio integration and health monitoring logic](assets/image.png)
...
- [Account Research Agent](../account-research-agent-by-onepage/index.md) - Automate deep-dive research on prospective and existing accounts.
- [Account Health Usage Monitor](../account-health-usage-monitor-by-jotform/index.md) - Track usage metrics and form-based feedback for account health.
