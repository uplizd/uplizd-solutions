...
## Demo
![Customer Account Health Monitor dashboard showing real-time risk scores and account status updates](assets/image.png)
...
- [Account Health Usage Monitor](../account-health-usage-monitor-by-jotform/index.md) - Track product usage metrics to supplement health scores.
- [Deal Pipeline Manager](../deal-pipeline-manager/index.md) - Manage sales stages and follow-up tasks for active opportunities.
- [CRM Data Sync Agent](../crm-data-sync-agent/index.md) - Ensure seamless data synchronization across your entire CRM ecosystem.
