...
## Demo
![Compliance Call Monitor workflow interface showing automated transcription and regulatory flag analysis](assets/image.png)
...
- [Action Item Cleanup Agent](../action-item-cleanup-agent-by-rootly/index.md) - Automate the resolution of follow-up tasks from meetings.
- [Work Hours Compliance Monitor](../work-hours-compliance-monitor-by-timely/index.md) - Track and report on employee work hour regulations.
