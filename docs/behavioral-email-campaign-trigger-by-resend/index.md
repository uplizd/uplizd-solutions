...
## Demo
![Behavioral Email Campaign Trigger workflow showing Chat Input, Agent node, Resend integration, and Chat Output](assets/image.png)
...
* [WhatsApp Lead Nurturing Agent](../whats-app-lead-nurturing-agent-by-spoki/index.md) — Multi-channel engagement for lead qualification.
* [CRM Data Sync Agent](../crm-data-sync-agent/index.md) — Maintain synchronized user data across your CRM and marketing tools.
