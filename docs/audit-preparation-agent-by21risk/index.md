...
## Demo
![Audit Preparation Agent dashboard showing automated data collection and compliance validation workflows](assets/image.png)
...
* [Admin User Access Auditor](../admin-user-access-auditor-by-storeganise/index.md) - Specialized monitoring for user permissions and access rights.
