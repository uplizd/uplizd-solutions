...
## Demo
![Pipeline Forecasting Assistant dashboard showing revenue projections and CRM data integration](assets/image.png)
...
- [Deal Pipeline Manager](../deal-pipeline-manager/index.md) — Optimize pipeline stages and follow-up cadences.
