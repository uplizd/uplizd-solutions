...
## Demo
![Space Inventory Agent dashboard showing real-time Contentful workspace usage metrics and asset distribution analytics](assets/image.png)
...
## Related Solutions
* [Account Audit Agent by Cloudflare](../account-audit-agent-by-cloudflare/index.md) - Automates security and configuration audits for network infrastructure.
* [Workflow Health Monitor by Dailybot](../workflow-health-monitor-by-dailybot/index.md) - Tracks the operational status and efficiency of automated business processes.
* [Admin User Access Auditor by Storeganise](../admin-user-access-auditor-by-storeganise/index.md) - Monitors and reports on user permissions and access levels across platforms.
