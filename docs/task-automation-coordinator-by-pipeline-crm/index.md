...
## Demo
![Task Automation Coordinator workflow dashboard showing automated task scheduling and CRM sync](assets/image.png)
...
- [CRM Data Sync Agent](../crm-data-sync-agent/index.md) - Sync data across platforms with conflict resolution.
- [CRM Data Hygiene Manager](../crm-data-hygiene-manager/index.md) - Clean up CRM data and manage decay.
- [Account Research Agent](../account-research-agent/index.md) - Gather intelligence on target accounts.
