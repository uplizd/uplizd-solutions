...
![Content Research Assistant workflow showing Apify integration for automated scraping and trend analysis](assets/image.png)
...
- [Market Research Assistant](../market-research-assistant/index.md) — Deep-dive into firmographics, funding status, and detailed profiling of competitor companies.
- [Research Insight Synthesizer](../research-insight-synthesizer/index.md) — Synthesize qualitative findings from the web and community discussions into strategic reports.
- [Contact Sync Manager](../contact-sync-manager/index.md) — Save and sync your enriched content data and contacts directly into your marketing stack.
