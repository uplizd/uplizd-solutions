...
## Demo
![Conversation Insights Agent workflow dashboard showing LinkedIn message analysis and sentiment extraction](assets/image.png)
...
*   [CRM Data Hygiene Manager](../crm-data-hygiene-manager/index.md) - Clean up and format CRM data.
*   [Account Intelligence Gatherer](../account-intelligence-gatherer-by-dropcontact/index.md) - Enrich account data for better targeting.
