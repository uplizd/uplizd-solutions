...
## Demo
![Client Intake Document Agent workflow showing automated document parsing and CRM update steps](assets/image.png)
...
## Related Solutions
- [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) - Automates the creation and configuration of new client accounts.
- [CRM Data Sync Agent](../crm-data-sync-agent/index.md) - Ensures data consistency across multiple platforms and CRM instances.
- [Action Item Cleanup Agent](../action-item-cleanup-agent-by-rootly/index.md) - Organizes and prioritizes follow-up tasks derived from client interactions.
