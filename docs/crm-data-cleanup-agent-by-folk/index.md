...
## Demo
![CRM Data Cleanup Agent dashboard showing duplicate contact detection and merge confirmation in Folk CRM](assets/image.png)
...
- [CRM Data Hygiene Manager](../crm-data-hygiene-manager/index.md) - Advanced tools for formatting and compliance-aware data cleanup.
- [Account Research Agent](../account-research-agent-by-onepage/index.md) - Enrich your CRM records with external account intelligence.
