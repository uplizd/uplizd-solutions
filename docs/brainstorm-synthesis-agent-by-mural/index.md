...
## Demo
![Brainstorm Synthesis Agent workflow showing idea clustering and prioritization in Mural](assets/image.png)
...
## Related Solutions
* [Workshop Facilitator Agent](../workshop-facilitator-agent-by-mural/index.md) - Automates the end-to-end management of collaborative workshop sessions.
* [Workshop Template Curator](../workshop-template-curator-by-miro/index.md) - Manages and deploys standardized templates for team brainstorming.
* [Action Item Prioritizer](../action-item-prioritizer-by-rootly/index.md) - Ranks and assigns tasks derived from meeting and brainstorming outputs.
