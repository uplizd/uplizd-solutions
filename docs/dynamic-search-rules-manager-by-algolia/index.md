...
## Demo
![Dynamic Search Rules Manager workflow interface showing Algolia integration nodes](assets/image.png)
...
- [Account Intelligence Reporter](../account-intelligence-reporter-by-leadfeeder/index.md) — Sync lead data and account insights to improve pipeline visibility.
