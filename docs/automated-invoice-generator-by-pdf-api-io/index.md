...
## Demo
![Automated Invoice Generator workflow interface showing data extraction from CRM to PDF generation](assets/image.png)
...
- [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) — Streamline new client onboarding and CRM record creation.
- [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) — Manage end-to-end business process orchestration.
