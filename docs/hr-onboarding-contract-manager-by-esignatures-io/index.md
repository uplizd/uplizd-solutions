...
## Demo
![HR Onboarding Contract Manager workflow showing Chat Input, Agent, Composio Toolset, and eSignatures.io integration](assets/image.png)
...
## Related Solutions
- [Workforce Onboarding Automator](../workforce-onboarding-automator-by-connecteam/index.md) - Streamlines general employee onboarding tasks and communications.
- [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) - Automates the creation and configuration of new user accounts in CRM.
- [Action Item Prioritizer](../action-item-prioritizer-by-rootly/index.md) - Helps manage and prioritize follow-up tasks generated from HR or project workflows.
