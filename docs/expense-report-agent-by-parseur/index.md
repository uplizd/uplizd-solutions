...
## Demo
![Expense Report Agent workflow diagram showing receipt parsing and report generation](assets/image.png)
...
*   [Affiliate Payment Automation Agent](../affiliate-payment-automation-agent-by-tapfiliate/index.md) - Streamline outgoing payments and financial tracking for affiliate programs.
*   [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) - General purpose automation for managing business processes and data flow.
