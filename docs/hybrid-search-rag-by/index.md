...
## Demo
![Hybrid Search RAG workflow diagram showing vector and keyword retrieval integration](assets/image.png)
...
- [Account Intelligence Reporter](../account-intelligence-reporter-by-leadfeeder/index.md) - Generates comprehensive reports on account activity and intent.
- [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) - Streamlines complex operational workflows across platforms.
