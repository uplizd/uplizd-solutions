...
## Demo
![Automated Search Index Manager workflow showing Chat Input, Agent, Algolia Composio Toolset, and Chat Output nodes](assets/image.png)
...
## Related Solutions
- [Account Research Agent](../account-research-agent-by-onepage/index.md) - Automate account intelligence gathering for sales teams.
- [CRM Data Sync Agent](../crm-data-sync-agent/index.md) - Synchronize data across multiple CRM platforms and data stores.
- [Deal Pipeline Manager](../deal-pipeline-manager/index.md) - Manage sales pipeline stages and deal velocity.
- [Account Intelligence Reporter](../account-intelligence-reporter-by-leadfeeder/index.md) - Generate automated reports on account activity and engagement.
