...
## Demo
![Audit Document Comparator workflow showing document upload, Draftable comparison, and change summary output](assets/image.png)
...
## Related Solutions
- [Account Audit Agent](../account-audit-agent-by-cloudflare/index.md) - Automates infrastructure and account-level security audits.
- [Action Item Prioritizer](../action-item-prioritizer-by-rootly/index.md) - Manages and ranks tasks derived from audit and meeting notes.
