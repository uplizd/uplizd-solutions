...
## Demo
![Sprint Retrospective Analyzer workflow interface showing feedback synthesis and trend analysis](assets/image.png)
...
## Related Solutions
*   [Workshop Facilitator Agent](../workshop-facilitator-agent-by-mural/index.md) - Automate the management and coordination of collaborative workshop sessions.
*   [Workshop Template Curator](../workshop-template-curator-by-miro/index.md) - Manage and deploy standardized workshop templates across distributed teams.
*   [Workflow Health Monitor](../workflow-health-monitor-by-dailybot/index.md) - Track and report on the operational efficiency of team workflows and daily standups.
