...
## Demo
![Daily Standup Bot workflow interface showing automated collection of team status updates and summary generation](assets/image.png)
...
## Related Solutions
- [Workflow Health Monitor](../workflow-health-monitor-by-dailybot/index.md) - Track the efficiency and status of your automated workflows.
- [Account Relationship Builder](../account-relationship-builder-by-dynamics365/index.md) - Manage and nurture professional connections within your CRM.
