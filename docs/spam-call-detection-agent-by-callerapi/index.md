...
## Demo
![Spam Call Detection Agent workflow interface showing CallerAPI integration and real-time threat analysis](assets/image.png)
...
* [whats-app-support-triage-agent-by-wati](../whats-app-support-triage-agent-by-wati/index.md) — Manage and triage support tickets across messaging channels.
* [account-verification-assistant-by-twocaptcha](../account-verification-assistant-by-twocaptcha/index.md) — Secure user onboarding through automated verification processes.
