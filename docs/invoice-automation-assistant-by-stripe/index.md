...
## Demo
![Invoice Automation Assistant workflow diagram showing Chat Input, Agent, Stripe Composio Toolset, and Chat Output nodes](assets/image.png)
...
- [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) — Streamline customer onboarding and data entry.
- [Affiliate Payment Automation Agent](../affiliate-payment-automation-agent-by-tapfiliate/index.md) — Manage partner payouts and commission tracking.
