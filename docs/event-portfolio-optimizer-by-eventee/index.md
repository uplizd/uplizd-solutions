...
## Demo
![Event Portfolio Optimizer dashboard showing speaker allocation metrics and event scheduling insights](assets/image.png)
...
## Related Solutions
- [Workshop Template Curator](../workshop-template-curator-by-miro/index.md) - Manage and deploy standardized workshop templates for your events.
- [Account Intelligence Reporter](../account-intelligence-reporter-by-leadfeeder/index.md) - Gather deep insights on account interactions to inform your event invite lists.
- [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) - Automate complex operational tasks across your business platforms.
