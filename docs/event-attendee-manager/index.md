...
![Event Attendee Manager flow automating attendee lists and post-event segmentation](assets/image.png)
...
- [Contact Sync Manager](../contact-sync-manager/index.md) — Keep your attendee lists in sync across all your marketing and CRM platforms.
- [Professional Email Clarity Assistant](../professional-email-clarity-assistant/index.md) — Refine your follow-up templates and personal outreach for maximum clarity and impact.
- [Invoice Processing Agent](../invoice-processing-agent/index.md) — Automate the handling of event vendor invoices and attendee payments efficiently.
