...
## Demo
![Follow-up Reminder Agent workflow showing Chat Input, Agent node, Composio Toolset, and Chat Output nodes](assets/image.png)
...
## Related Solutions
- [Account Research Agent](../account-research-agent-by-onepage/index.md) — Automate deep-dive research on prospects to personalize outreach.
- [Deal Pipeline Manager](../deal-pipeline-manager/index.md) — Manage pipeline stages and identify stalled deals for SalesOps teams.
- [WhatsApp Lead Qualifier](../whats-app-lead-qualifier-by-wati/index.md) — Qualify incoming leads via WhatsApp to streamline the handoff process.
