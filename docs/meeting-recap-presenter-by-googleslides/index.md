...
## Demo
![Meeting Recap Presenter workflow screenshot showing transcript processing into Google Slides](assets/image.png)
...
## Related Solutions
- [Action Item Cleanup Agent](../action-item-cleanup-agent-by-rootly/index.md) — Automates the tracking and resolution of meeting action items.
- [Action Item Prioritizer](../action-item-prioritizer-by-rootly/index.md) — Ranks and assigns meeting tasks based on urgency and impact.
- [Workshop Template Curator](../workshop-template-curator-by-miro/index.md) — Manages and deploys visual collaboration templates for team sessions.
