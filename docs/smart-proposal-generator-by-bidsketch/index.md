...
## Demo
![Smart Proposal Generator workflow diagram showing CRM data integration with Bidsketch for automated document creation](assets/image.png)
...
- [Deal Pipeline Manager](../deal-pipeline-manager/index.md) — Maintain overall pipeline health and stage hygiene.
- [CRM Data Sync Agent](../crm-data-sync-agent/index.md) — Ensure data consistency across all sales platforms.
