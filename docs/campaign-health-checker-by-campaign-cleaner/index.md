...
## Demo
![Campaign Health Checker workflow interface showing automated monitoring of email metrics and alert triggers](assets/image.png)
...
- [../account-health-compliance-monitor-by-brevo/README.md](../account-health-compliance-monitor-by-brevo/index.md) - Monitor account compliance and health metrics.
- [../crm-data-hygiene-manager/README.md](../crm-data-hygiene-manager/index.md) - Maintain clean and actionable CRM data.
