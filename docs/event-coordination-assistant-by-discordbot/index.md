...
## Demo
![Event Coordination Assistant workflow diagram showing Discord event creation and member notification flow](assets/image.png)
...
* [whats-app-support-ticket-manager-by-spoki](../whats-app-support-ticket-manager-by-spoki/index.md) - Streamlined support triage for WhatsApp channels.
* [workshop-facilitator-agent-by-mural](../workshop-facilitator-agent-by-mural/index.md) - Collaborative workshop management and facilitation tools.
