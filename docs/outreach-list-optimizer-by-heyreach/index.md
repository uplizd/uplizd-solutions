...
## Demo
![Outreach List Optimizer workflow diagram showing data ingestion, AI-driven segmentation, and CRM synchronization](assets/image.png)
...
- [CRM Data Hygiene Manager](../crm-data-hygiene-manager/index.md) - Maintain high-quality, decay-free CRM data.
