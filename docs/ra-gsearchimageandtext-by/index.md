...
## Demo
![RAG Search Image and Text workflow diagram showing image and text ingestion, vector indexing, and AI-powered retrieval](assets/image.png)
...
- [YouTube Analysis](../you-tube-analysis-by/index.md) - Provides deep insights into video content performance and audience engagement.
- [Accessibility Audit Assistant](../accessibility-audit-assistant-by-figma/index.md) - Streamlines the auditing of design assets for compliance and usability.
