...
## Demo
![Customer Thank You Card Agent workflow diagram showing purchase trigger, AI personalization, and Stannp dispatch](assets/image.png)
...
## Related Solutions
- [Account Relationship Builder](../account-relationship-builder-by-dynamics365/index.md) — Enhance client connections using Dynamics 365 data.
- [Abandoned Cart Recovery Agent](../abandoned-cart-recovery-agent-by-klaviyo/index.md) — Re-engage customers through automated digital workflows.
- [CRM Data Sync Agent](../crm-data-sync-agent/index.md) — Ensure customer data consistency across your entire tech stack.
