...
## Demo
![Contract Automation Agent workflow showing document generation and signature tracking](assets/image.png)
...
## Related Solutions
- [../account-setup-agent-by-salesforce/README.md](../account-setup-agent-by-salesforce/index.md) - Automate account creation and data entry.
