...
## Demo
![Project Status Reporter workflow showing JobNimbus data extraction and automated client report generation](assets/image.png)
...
## Related Solutions
- [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) — Streamline general JobNimbus workflows and task management.
- [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) — Automate the initial configuration and data entry for new client accounts.
- [Work Order Status Tracker](../work-order-status-tracker-by-maintainx/index.md) — Monitor and report on field service work orders and maintenance tasks.
