...
## Demo
![Brand News Sentiment Tracker dashboard showing real-time news mentions and sentiment scores](assets/image.png)
...
## 🚀 Run on Uplizd
[![Run on Uplizd](https://img.shields.io/badge/Run_on-Uplizd-blue?logo=uplizd)](https://uplizd.ai/solutions/ab3e88cd-9862-54b6-8502-b6a77a900da0)
...
## Related Solutions
- [Account Intelligence Reporter](../account-intelligence-reporter-by-leadfeeder/index.md) — Gather deep account insights and news for sales teams.
- [YouTube Content Performance Optimizer](../you-tube-content-performance-optimizer-by-youtube/index.md) — Analyze video engagement and audience sentiment.
- [Workflow Health Monitor](../workflow-health-monitor-by-dailybot/index.md) — Track the operational status of your automated business processes.
