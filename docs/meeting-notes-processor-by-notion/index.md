...
## Demo
![Meeting Notes Processor dashboard showing transcript parsing into structured action items and summary](assets/image.png)
...
*   [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) - Automate broader business processes beyond meeting notes.
*   [Account Relationship Builder](../account-relationship-builder-by-dynamics365/index.md) - Maintain deep client context alongside meeting documentation.
