...
## Demo
![Workshop Facilitator Agent interface showing automated Mural board setup and agenda management](assets/image.png)
...
## Related Solutions
* [Workshop Template Curator (Miro)](../workshop-template-curator-by-miro/index.md) — Manage and organize collaborative templates in Miro.
* [Workflow Automation Agent (JobNimbus)](../workflow-automation-agent-by-jobnimbus/index.md) — Streamline operational workflows for field services.
* [Account Research Agent (OnePage)](../account-research-agent-by-onepage/index.md) — Automate account intelligence gathering for sales teams.
