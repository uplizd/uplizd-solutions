...
## Demo
![Lead Cleanup Assistant workflow interface showing automated data deduplication and formatting nodes](assets/image.png)
...
* [CRM Data Hygiene Manager](../crm-data-hygiene-manager/index.md) - Comprehensive data decay and compliance-aware cleanup.
* [Deal Pipeline Manager](../deal-pipeline-manager/index.md) - Manage deal stages and follow-up automation.
* [Account Intelligence Gatherer](../account-intelligence-gatherer/index.md) - Enrich account records with external intelligence.
