...
## Demo
![Bonsai Capacity Planning Assistant workflow dashboard showing resource utilization metrics and automated scaling recommendations](assets/image.png)
...
- [Account Audit Agent](../account-audit-agent-by-cloudflare/index.md) - Perform comprehensive security and resource audits on your cloud infrastructure.
- [Workspace Usage Analyzer](../workspace-usage-analyzer-by-baserow/index.md) - Analyze data usage patterns to optimize workspace resource allocation.
