...
## Demo
![Box AI Document Assistant interface showing a document query workflow](assets/image.png)
...
## Related Solutions
- [Account Research Assistant](../account-research-assistant-by-zoominfo/index.md) — Gather deep intelligence on accounts and prospects.
- [Action Item Prioritizer](../action-item-prioritizer-by-rootly/index.md) — Organize and rank tasks extracted from documentation.
