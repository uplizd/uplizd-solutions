...
## Demo
![Client Data Synchronizer workflow diagram showing Bidsketch integration with CRM systems](assets/image.png)
...
- [Account Research Agent](../account-research-agent/index.md) - Enriches client records with external intelligence.
- [Deal Pipeline Manager](../deal-pipeline-manager/index.md) - Manages deal stages and follow-up automation.
