...
## Demo
![Lead Enrichment Agent workflow showing Chat Input, Agent node, Composio Toolset, and Chat Output](assets/image.png)
...
## Related Solutions
- [Account Research Agent](../account-research-agent-by-onepage/index.md) — Deep-dive research and intelligence gathering for target accounts.
- [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) — Automated account provisioning and configuration for sales teams.
- [CRM Data Sync Agent](../crm-data-sync-agent/index.md) — Multi-platform synchronization to maintain data consistency across your stack.
