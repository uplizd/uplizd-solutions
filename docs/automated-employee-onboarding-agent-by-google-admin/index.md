...
## Demo
![Automated Employee Onboarding Agent workflow showing Google Workspace user provisioning and group assignment](assets/image.png)
...
## Related Solutions
- [Admin User Access Auditor](../admin-user-access-auditor-by-storeganise/index.md) — Monitor and audit user permissions across your organization.
- [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) — Automate account creation and management within Salesforce.
- [Workforce Onboarding Automator](../workforce-onboarding-automator-by-connecteam/index.md) — Manage employee onboarding workflows and task tracking.
