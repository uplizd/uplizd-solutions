...
## Demo
![Customer Relationship Historian workflow diagram showing data flow from CentralStationCRM to the AI Agent for synthesis](assets/image.png)
...
* [CRM Data Sync Agent](../crm-data-sync-agent/index.md) — Synchronize data across multiple platforms and CRM instances.
* [Deal Pipeline Manager](../deal-pipeline-manager/index.md) — Manage sales stages and track deal progression effectively.
