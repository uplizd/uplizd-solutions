...
## Demo
![Financial Data Consolidator workflow showing automated data ingestion from accounting software and output to reporting dashboards](assets/image.png)
...
- [CRM Data Sync Agent](../crm-data-sync-agent/index.md) - Synchronizes customer and opportunity data across multiple CRM platforms.
- [CRM Data Hygiene Manager](../crm-data-hygiene-manager/index.md) - Cleans and standardizes CRM contact and account data to prevent decay.
