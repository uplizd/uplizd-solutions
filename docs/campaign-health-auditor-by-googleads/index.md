...
## Demo
![Campaign Health Auditor dashboard showing automated performance insights and budget optimization alerts](assets/image.png)
...
- [Account Health Usage Monitor](../account-health-usage-monitor-by-jotform/index.md) - Track overall account health and platform engagement metrics.
- [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) - Streamline cross-platform marketing and sales workflows.
