...
## Demo
![Estimate to Invoice Converter workflow screenshot showing the transition from estimate approval to invoice generation in Elorus](assets/image.png)
...
- [Affiliate Payment Automation Agent](../affiliate-payment-automation-agent-by-tapfiliate/index.md) - Streamline commission payouts and financial tracking.
- [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) - General purpose task orchestration for business operations.
