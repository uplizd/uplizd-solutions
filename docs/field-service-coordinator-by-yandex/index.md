...
## Demo
![Field Service Coordinator workflow dashboard showing automated technician dispatch and route optimization nodes](assets/image.png)
...
- [Account Research Agent](../account-research-agent-by-onepage/index.md) — Gather deep customer intelligence to prepare for on-site visits.
- [Action Item Prioritizer](../action-item-prioritizer-by-rootly/index.md) — Manage and rank incoming service requests based on urgency.
