...
## Demo
![Customer Lifecycle Manager workflow dashboard showing RepairShopr integration and lifecycle status updates](assets/image.png)
...
- [CRM Data Hygiene Manager](../crm-data-hygiene-manager/index.md) - Automate data cleanup and formatting for better CRM health.
- [Deal Pipeline Manager](../deal-pipeline-manager/index.md) - Manage sales stages and pipeline velocity effectively.
