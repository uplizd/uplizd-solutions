...
## Demo
![Meeting Notes Publisher workflow diagram showing transcript input, AI processing, and Confluence page creation](assets/image.png)
...
## Related Solutions
- [Action Item Prioritizer](../action-item-prioritizer-by-rootly/index.md) — Organize and track tasks extracted from meeting discussions.
- [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) — Streamline cross-platform tasks triggered by documentation updates.
- [Account Intelligence Reporter](../account-intelligence-reporter-by-leadfeeder/index.md) — Sync customer meeting insights with account research data.
