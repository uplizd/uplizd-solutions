...
## Demo
![Visual Meeting Documenter workflow diagram showing Chat Input, AI Agent, Mural integration, and final board output](assets/image.png)
...
## Related Solutions
*   [Workshop Facilitator Agent](../workshop-facilitator-agent-by-mural/index.md) - Automates the management and flow of interactive workshop sessions.
*   [Workshop Template Curator](../workshop-template-curator-by-miro/index.md) - Manages and deploys standardized templates across collaborative workspaces.
*   [Action Item Prioritizer](../action-item-prioritizer-by-rootly/index.md) - Organizes and ranks tasks extracted from meeting logs and incident reports.
