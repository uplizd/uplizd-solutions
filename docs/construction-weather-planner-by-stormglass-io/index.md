...
## Demo
![Construction Weather Planner workflow showing weather data integration and automated schedule adjustment](assets/image.png)
...
## Related Solutions
- [Work Order Status Tracker](../work-order-status-tracker-by-maintainx/index.md) - Monitor and update field maintenance tasks.
- [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) - Streamline construction project workflows and data entry.
- [Account Research Agent](../account-research-agent-by-onepage/index.md) - Gather intelligence on project stakeholders and contractors.
