...
## Demo
![Maintenance Request Processor workflow diagram showing input, AI categorization, and MaintainX integration](assets/image.png)
...
- [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) - Automate general operational workflows and task routing.
- [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) - Standardize data entry and account creation processes.
