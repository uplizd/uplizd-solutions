...
## Demo
![Meeting Action Item Tracker workflow showing transcript input, AI processing, and Google Tasks integration](assets/image.png)
...
## Related Solutions
- [Action Item Cleanup Agent](../action-item-cleanup-agent-by-rootly/index.md) — Automate the removal of stale or completed tasks.
- [Action Item Prioritizer](../action-item-prioritizer-by-rootly/index.md) — Rank your tasks based on project urgency and impact.
- [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) — Connect meeting outcomes to broader CRM and project workflows.
