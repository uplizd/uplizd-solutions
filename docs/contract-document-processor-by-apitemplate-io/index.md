...
## Demo
![Contract Document Processor workflow showing input, agent processing, and PDF generation](assets/image.png)
...
- [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) - Automate the onboarding of new clients in your CRM.
- [Action Item Prioritizer](../action-item-prioritizer-by-rootly/index.md) - Manage follow-up tasks derived from contract negotiations.
