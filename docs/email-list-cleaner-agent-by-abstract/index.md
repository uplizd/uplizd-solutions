...
## Demo
![Email List Cleaner Agent workflow interface showing input validation, email scoring, and list export nodes in Uplizd](assets/image.png)
...
## Related Solutions
* [CRM Data Hygiene Manager](../crm-data-hygiene-manager/index.md) — Automates the cleanup of duplicate and decayed CRM records.
* [CRM Data Sync Agent](../crm-data-sync-agent/index.md) — Synchronizes contact data across multiple platforms to ensure consistency.
* [Abandoned Cart Recovery Agent](../abandoned-cart-recovery-agent-by-klaviyo/index.md) — Targets verified contacts with automated recovery sequences.
