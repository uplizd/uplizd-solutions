...
## Demo
![Social Media Content Automator workflow showing content input, Canva design generation, and output scheduling](assets/image.png)
...
- [Accessibility Compliance Monitor](../accessibility-compliance-monitor-by-alttext-ai/index.md) — Ensure all visual assets meet web accessibility standards.
- [Affiliate Program Optimizer](../affiliate-program-optimizer-by-lemon-squeezy/index.md) — Manage and scale affiliate marketing visual assets.
