...
## Demo
![Design Feedback Orchestrator workflow showing automated feedback routing from stakeholders to Figma via Composio](assets/image.png)
...
## Related Solutions
- [Accessibility Audit Assistant](../accessibility-audit-assistant-by-figma/index.md) - Automate accessibility compliance checks within your design files.
- [Workshop Template Curator](../workshop-template-curator-by-miro/index.md) - Manage and deploy collaborative workshop templates for design teams.
- [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) - General purpose workflow orchestration for cross-functional project management.
