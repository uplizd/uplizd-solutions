...
## Demo
![Employee Offboarding Security Agent workflow diagram showing SharePoint access revocation and permission cleanup](assets/image.png)
...
## Related Solutions
- [Admin User Access Auditor](../admin-user-access-auditor-by-storeganise/index.md) — Monitors and audits administrative access rights across systems.
- [Workforce Onboarding Automator](../workforce-onboarding-automator-by-connecteam/index.md) — Streamlines the setup and provisioning for new employees.
- [Account Health Compliance Monitor](../account-health-compliance-monitor-by-brevo/index.md) — Tracks and enforces account-level security and compliance standards.
