...
## Demo
![BART Schedule Optimizer workflow diagram showing data input, AI analysis, and schedule output nodes](assets/image.png)
...
* [Work Order Status Tracker](../work-order-status-tracker-by-maintainx/index.md) — Manage and track maintenance tasks for transit infrastructure.
* [Account Health Usage Monitor](../account-health-usage-monitor-by-jotform/index.md) — Track usage patterns and operational health metrics.
