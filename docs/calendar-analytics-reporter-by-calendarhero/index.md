...
## Demo
![Calendar Analytics Reporter dashboard showing meeting density and time distribution charts](assets/image.png)
...
## Related Solutions
* [Workspace Usage Analyzer](../workspace-usage-analyzer-by-baserow/index.md) — Monitor and optimize workspace resource utilization.
