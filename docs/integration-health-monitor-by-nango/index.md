...
## Demo
![Integration Health Monitor dashboard showing real-time API status, latency metrics, and automated alert triggers for Nango-connected services.](assets/image.png)
...
* [CRM Data Hygiene Manager](../crm-data-hygiene-manager/index.md) - Automate data cleanup and formatting to maintain high-quality records.
* [Workflow Health Monitor](../workflow-health-monitor-by-dailybot/index.md) - Monitor general workflow execution health and team productivity metrics.
