...
## Demo
![Contract Analysis Agent workflow interface showing document upload and clause extraction results](assets/image.png)
...
## Related Solutions
- [Account Research Agent](../account-research-agent-by-onepage/index.md) — Gather intelligence on companies to contextualize legal agreements.
- [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) — Sync extracted contract data into your CRM account records.
- [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) — Trigger downstream business processes based on extracted contract terms.
