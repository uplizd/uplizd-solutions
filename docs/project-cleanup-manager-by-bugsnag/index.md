...
## Demo
![Project Cleanup Manager dashboard showing automated issue archival and stale data removal workflows](assets/image.png)
...
## Related Solutions
- [Action Item Cleanup Agent](../action-item-cleanup-agent-by-rootly/index.md) — Automate the resolution and cleanup of stale action items.
