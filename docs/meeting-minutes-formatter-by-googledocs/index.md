...
## Demo
![Meeting Minutes Formatter workflow showing raw text input being processed into a structured Google Doc](assets/image.png)
...
## Related Solutions
*   [Action Item Cleanup Agent](../action-item-cleanup-agent-by-rootly/index.md) — Automate the resolution and tracking of meeting-derived tasks.
*   [Action Item Prioritizer](../action-item-prioritizer-by-rootly/index.md) — Rank and organize action items based on urgency and project impact.
*   [Workflow Health Monitor](../workflow-health-monitor-by-dailybot/index.md) — Track team productivity and meeting efficiency metrics over time.
