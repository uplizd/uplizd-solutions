...
## Demo
![User Lifecycle Manager workflow showing automated account provisioning and status updates in D2L Brightspace](assets/image.png)
...
## Related Solutions
*   [Workforce Onboarding Automator](../workforce-onboarding-automator/index.md) - Streamlines employee onboarding and access management.
*   [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) - Automates account configuration and setup tasks.
*   [Admin User Onboarding Assistant](../admin-user-onboarding-assistant-by-storeganise/index.md) - Simplifies the onboarding process for administrative user roles.
