...
## Demo
![Lead Nurture Campaign Automator workflow showing Chat Input, Agent, Moosend Composio Toolset, and Chat Output nodes](assets/image.png)
...
## Related Solutions
- [Abandoned Cart Recovery Agent](../abandoned-cart-recovery-agent-by-klaviyo/index.md) — Recovers lost revenue through automated email recovery sequences.
- [WhatsApp Lead Nurturing Agent](../whats-app-lead-nurturing-agent-by-spoki/index.md) — Extends nurture capabilities to mobile messaging platforms.
- [Account Intelligence Gatherer](../account-intelligence-gatherer-by-dropcontact/index.md) — Enriches lead data to improve the personalization of nurture campaigns.
