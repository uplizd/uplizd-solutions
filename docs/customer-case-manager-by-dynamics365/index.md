...
## Demo
![Customer Case Manager workflow diagram showing intake, AI routing, and Dynamics 365 integration](assets/image.png)
...
- [account-setup-agent-by-salesforce](../account-setup-agent-by-salesforce/index.md) — Automates account creation and onboarding workflows in Salesforce.
- [whats-app-support-ticket-manager-by-spoki](../whats-app-support-ticket-manager-by-spoki/index.md) — Manages support tickets specifically via WhatsApp channels.
