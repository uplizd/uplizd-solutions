...
## Demo
![Pitch Deck Generator workflow interface showing data input to Google Slides automation](assets/image.png)
...
## Related Solutions
- [Account Research Agent](../account-research-agent-by-onepage/index.md) — Gather deep account intelligence to inform your pitch deck content.
- [Account Intelligence Reporter](../account-intelligence-reporter-by-leadfeeder/index.md) — Extract actionable insights from lead data to strengthen your market analysis slides.
- [Account Relationship Builder](../account-relationship-builder-by-dynamics365/index.md) — Manage and track investor relationships alongside your fundraising materials.
