...
## Demo
![Event Registration Form Manager workflow showing Tally form integration and automated CRM sync](assets/image.png)
...
- [CRM Data Sync Agent](../crm-data-sync-agent/index.md) — Synchronizes data across multiple platforms with conflict resolution.
- [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) — Automates the provisioning and configuration of new accounts.
