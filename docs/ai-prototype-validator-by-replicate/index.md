...
## Demo
![AI Prototype Validator workflow interface showing model input, validation logic, and output results](assets/image.png)
...
* [Account Intelligence Reporter](../account-intelligence-reporter-by-leadfeeder/index.md) - Generate comprehensive reports on account activities and lead signals.
