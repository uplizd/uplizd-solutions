...
## Demo
![Supabase Auth Integration Manager workflow diagram showing Chat Input connected to an Agent, Composio Toolset, and Chat Output](assets/image.png)
...
- [Admin User Onboarding Assistant](../admin-user-onboarding-assistant-by-storeganise/index.md) - Streamline user access and onboarding workflows.
