...
## Demo
![Vendor Network Management Agent workflow dashboard showing automated vendor invitation tracking and status synchronization](assets/image.png)
...
*   [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) - Streamline the creation and configuration of new client accounts.
*   [Workflow Health Monitor](../workflow-health-monitor-by-dailybot/index.md) - Track and optimize the performance of automated operational pipelines.
