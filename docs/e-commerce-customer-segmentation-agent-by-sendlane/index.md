...
## Demo
![eCommerce Customer Segmentation Agent workflow showing data flow from Sendlane to the AI Agent](assets/image.png)
...
## Related Solutions
- [Abandoned Cart Recovery Agent](../abandoned-cart-recovery-agent-by-klaviyo/index.md) - Automate recovery flows for lost sales.
- [CRM Data Sync Agent](../crm-data-sync-agent/index.md) - Synchronize customer data across multiple platforms.
- [WhatsApp Lead Nurturing Agent](../whats-app-lead-nurturing-agent-by-spoki/index.md) - Engage segmented leads via WhatsApp.
