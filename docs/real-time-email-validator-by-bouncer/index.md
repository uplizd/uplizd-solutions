...
## Demo
![Real-Time Email Validator workflow showing Chat Input, Agent, Bouncer integration, and Chat Output](assets/image.png)
...
- [CRM Data Hygiene Manager](../crm-data-hygiene-manager/index.md) — Maintain overall database health and remove duplicate records.
- [Account Research Agent](../account-research-agent-by-onepage/index.md) — Automate deep-dive research on target accounts and leads.
