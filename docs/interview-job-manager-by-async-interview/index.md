...
## Demo
![Interview Job Manager dashboard showing automated candidate scheduling and status updates](assets/image.png)
...
* [Account Research Assistant](../account-research-assistant-by-zoominfo/index.md) - Gather deep intelligence on prospective clients and companies.
* [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) - General purpose automation for business process management.
