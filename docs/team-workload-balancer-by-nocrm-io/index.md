...
## Demo
![Team Workload Balancer workflow showing lead input, capacity analysis, and CRM assignment nodes](assets/image.png)
...
- [Account Research Agent](../account-research-agent/index.md) - Automate lead qualification and background research.
- [CRM Data Sync Agent](../crm-data-sync-agent/index.md) - Ensure multi-platform data consistency and sync.
