...
## Demo
![Deep Research Agent workflow interface showing multi-source query aggregation and report generation](assets/image.png)
...
## Related Solutions
- [Account Research Agent](../account-research-agent-by-onepage/index.md) — Targeted intelligence gathering for specific sales accounts.
- [Account Intelligence Reporter](../account-intelligence-reporter-by-leadfeeder/index.md) — Aggregates intent data for high-value prospect tracking.
- [YouTube Analysis](../you-tube-analysis-by/index.md) — Extracts insights and research data from video content.
