...
## Demo
![Research Data Anonymization Agent workflow interface showing PII detection and masking nodes](assets/image.png)
...
* [Admin User Access Auditor](../admin-user-access-auditor-by-storeganise/index.md) - Monitors and audits user permissions and access logs.
