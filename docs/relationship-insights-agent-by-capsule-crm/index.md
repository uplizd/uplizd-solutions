...
## Demo
![Relationship Insights Agent dashboard showing interaction trends and CRM health scores](assets/image.png)
...
* [Account Intelligence Gatherer](../account-intelligence-gatherer-by-dropcontact/index.md) — Enrich account data and verify contact information automatically.
* [Deal Pipeline Manager](../deal-pipeline-manager/index.md) — Manage pipeline stages and automate follow-up workflows for stalled deals.
