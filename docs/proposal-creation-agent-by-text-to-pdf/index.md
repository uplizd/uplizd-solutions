...
## Demo
![Proposal Creation Agent workflow diagram showing text input, AI processing, and PDF output](assets/image.png)
...
## Related Solutions
*   [Account Research Agent](../account-research-agent-by-onepage/index.md) — Gather deep account intelligence to personalize your proposals.
*   [Deal Pipeline Manager](../deal-pipeline-manager/index.md) — Track the status of proposals as they move through your sales stages.
*   [CRM Data Sync Agent](../crm-data-sync-agent/index.md) — Keep client data consistent across your CRM and document generation tools.
