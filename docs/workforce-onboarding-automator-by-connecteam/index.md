...
## Demo
![Workforce Onboarding Automator workflow diagram showing Chat Input, Agent, Composio Toolset, and Chat Output nodes](assets/image.png)
...
## Related Solutions
* [Workforce Onboarding Automator](../workforce-onboarding-automator/index.md) - General workforce onboarding and lifecycle management.
...
* [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) - Automated account creation and configuration for CRM users.
