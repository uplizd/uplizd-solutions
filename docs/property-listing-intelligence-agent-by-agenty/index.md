...
## Demo
![Property Listing Intelligence Agent workflow dashboard showing automated data extraction and analysis nodes](assets/image.png)
...
- [Account Research Assistant](../account-research-assistant-by-zoominfo/index.md) - Deep-dive research into company profiles and market positioning.
- [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) - Streamline operational tasks across CRM and project management tools.
