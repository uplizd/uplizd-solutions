...
## Demo
![Order Analytics Reporter workflow dashboard showing automated data extraction and trend visualization](assets/image.png)
...
*   [Workflow Health Monitor](../workflow-health-monitor-by-dailybot/index.md) — Track the performance and uptime of your internal business processes.
*   [Workspace Usage Analyzer](../workspace-usage-analyzer-by-baserow/index.md) — Analyze data usage patterns across your connected databases.
