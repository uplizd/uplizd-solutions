...
## Demo
![Legal Document Curator dashboard showing automated document classification and compliance status tracking](assets/image.png)
...
## Related Solutions
* [Account Health Compliance Monitor](../account-health-compliance-monitor-by-brevo/index.md) - Ensures customer account data meets regulatory and internal standards.
* [Action Item Cleanup Agent](../action-item-cleanup-agent-by-rootly/index.md) - Manages and resolves pending tasks derived from legal and operational meetings.
* [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) - Automates the creation of new client records and associated legal documentation.
