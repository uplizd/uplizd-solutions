...
## Demo
![Twitter Customer Support Agent workflow diagram showing incoming tweets being processed by an AI agent and routed via Composio tools](assets/image.png)
...
- [WhatsApp Support Triage Agent](../whats-app-support-triage-agent-by-wati/index.md) - Multi-channel support triage for messaging platforms.
- [Action Item Prioritizer](../action-item-prioritizer-by-rootly/index.md) - Intelligent task sorting and escalation management.
