...
## Demo
![Box Secure Sharing Assistant workflow showing Chat Input, Agent, Composio Toolset, and Chat Output nodes](assets/image.png)
...
## Related Solutions
- [Account Setup Agent by Salesforce](../account-setup-agent-by-salesforce/index.md) - Automates user provisioning and CRM access management.
- [Admin User Access Auditor by Storeganise](../admin-user-access-auditor-by-storeganise/index.md) - Monitors and reports on user access rights across platforms.
- [Workflow Automation Agent by Jobnimbus](../workflow-automation-agent-by-jobnimbus/index.md) - Streamlines cross-platform operational workflows and task triggers.
