...
## Demo
![Team Capacity Planner dashboard showing real-time workload distribution and hiring gaps](assets/image.png)
...
- [Workflow Automation Agent by Jobnimbus](../workflow-automation-agent-by-jobnimbus/index.md) - Manage complex operational workflows across platforms.
