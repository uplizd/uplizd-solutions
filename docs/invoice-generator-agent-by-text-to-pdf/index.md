...
## Demo
![Invoice Generator Agent workflow interface showing data input, PDF conversion, and document output nodes](assets/image.png)
...
- [Affiliate Payment Automation Agent](../affiliate-payment-automation-agent-by-tapfiliate/index.md) - Streamline payouts and financial tracking for affiliate programs.
- [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) - Standardize client onboarding and CRM data entry workflows.
