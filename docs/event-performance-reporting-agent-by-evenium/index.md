...
## Demo
![Event Performance Reporting Agent dashboard showing attendee engagement metrics and ROI charts](assets/image.png)
...
*   [CRM Data Sync Agent](../crm-data-sync-agent/index.md) - Maintain data hygiene and synchronization across platforms.
