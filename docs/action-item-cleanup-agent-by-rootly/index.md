...
## Demo
![Action Item Cleanup Agent workflow interface showing automated task filtering and archival logic](assets/image.png)
...
## Related Solutions
* [Action Item Prioritizer (../action-item-prioritizer-by-rootly/README.md)](../action-item-prioritizer-by-rootly/index.md) - Organize and rank incoming tasks by urgency and impact.
* [Workflow Health Monitor (../workflow-health-monitor-by-dailybot/README.md)](../workflow-health-monitor-by-dailybot/index.md) - Track the efficiency and status of your team's automated workflows.
* [CRM Data Hygiene Manager (../crm-data-hygiene-manager/README.md)](../crm-data-hygiene-manager/index.md) - Maintain clean and accurate records within your CRM ecosystem.
