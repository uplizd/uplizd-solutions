...
## Demo
![Customer Support Bot Manager workflow diagram showing Chat Input, Agent, DocsBot AI toolset, and Chat Output](assets/image.png)
...
- [247-customer-support-chatbot-by-botstar](../247-customer-support-chatbot-by-botstar/index.md) — Automated chatbot solution for rapid customer engagement.
- [whats-app-support-triage-agent-by-wati](../whats-app-support-triage-agent-by-wati/index.md) — Specialized triage agent for WhatsApp support channels.
