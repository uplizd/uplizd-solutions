...
## Demo
![Meeting Transcription Processor workflow diagram showing audio input, CastingWords transcription, and AI summary output](assets/image.png)
...
## Related Solutions
- [Action Item Prioritizer](../action-item-prioritizer-by-rootly/index.md) — Organize and rank tasks extracted from meetings.
- [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) — Automate follow-up actions based on meeting outcomes.
- [Customer Support Voice Agent](../247-customer-support-voice-agent-by-bolna/index.md) — Manage voice-based customer interactions and support tickets.
