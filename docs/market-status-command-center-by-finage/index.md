...
## Demo
![Market Status Command Center dashboard showing real-time exchange connectivity and asset price alerts](assets/image.png)
...
* [Account Health Usage Monitor](../account-health-usage-monitor-by-jotform/index.md) - Track customer usage patterns and account health.
* [Workflow Health Monitor](../workflow-health-monitor-by-dailybot/index.md) - Monitor the operational status of your internal automated workflows.
