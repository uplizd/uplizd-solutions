...
## Demo
![Smart Collection Scheduler workflow interface showing Detrack integration and automated pickup scheduling](assets/image.png)
...
- [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) — Streamline general business process automation.
