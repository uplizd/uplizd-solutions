...
## Demo
![Automated Survey Research Agent workflow showing Chat Input, AI Agent, Composio Toolset, and Chat Output nodes](assets/image.png)
...
## 🚀 Run on Uplizd
[![Run on Uplizd](https://img.shields.io/badge/Run%20on-Uplizd-blue?logo=uplizd)](https://uplizd.ai/solutions/9b9faf02-df6d-5d7f-9254-c10ad22d4cc5)
...
## Related Solutions
- [Account Intelligence Gatherer](../account-intelligence-gatherer-by-dropcontact/index.md) — Enrich account data for better research targeting.
- [WhatsApp Feedback Collection Agent](../whats-app-feedback-collection-agent-by-whatsapp/index.md) — Collect customer feedback directly via WhatsApp.
- [YouTube Audience Research Agent](../you-tube-audience-research-agent-by-youtube/index.md) — Analyze audience sentiment and research trends on YouTube.
