...
## Demo
![Customer Feedback Analyzer workflow dashboard showing automated categorization and sentiment analysis nodes](assets/image.png)
...
## Related Solutions
- [247-customer-support-assistant-by-ai-ml-api](../247-customer-support-assistant-by-ai-ml-api/index.md) - General-purpose AI support assistant for automated ticket resolution.
...
- [whats-app-feedback-collection-agent-by-wati](../whats-app-feedback-collection-agent-by-wati/index.md) - Collect and analyze customer feedback via WhatsApp channels.
