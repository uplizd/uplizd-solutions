...
## Demo
![Lead Qualification Bot workflow diagram showing Telegram input, AI agent scoring, and CRM update](assets/image.png)
...
## Related Solutions
- [../whats-app-lead-qualifier-by-wati/README.md](../whats-app-lead-qualifier-by-wati/index.md) - Similar lead qualification logic adapted for WhatsApp.
- [../crm-data-sync-agent/README.md](../crm-data-sync-agent/index.md) - Synchronize lead data across multiple CRM platforms.
- [../deal-pipeline-manager/README.md](../deal-pipeline-manager/index.md) - Manage and track deal stages after lead qualification.
