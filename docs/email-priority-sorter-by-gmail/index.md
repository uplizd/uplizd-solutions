...
## Demo
![Email Priority Sorter workflow dashboard showing automated email triage and categorization](assets/image.png)
...
## Related Solutions
- [Action Item Prioritizer](../action-item-prioritizer-by-rootly/index.md): Focuses on extracting and organizing tasks from communications.
- [Customer Support Triage Agent](../whats-app-support-triage-agent-by-wati/index.md): Specializes in routing support tickets across messaging platforms.
- [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md): Manages broader operational tasks beyond just email.
