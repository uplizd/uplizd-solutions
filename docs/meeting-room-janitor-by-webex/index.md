...
## Demo
![Meeting Room Janitor dashboard showing automated cleanup logs and Webex space status](assets/image.png)
...
- [Workflow Health Monitor](../workflow-health-monitor-by-dailybot/index.md) — Tracks and reports on the operational status of your automated workflows.
- [Admin User Access Auditor](../admin-user-access-auditor-by-storeganise/index.md) — Audits and manages user permissions across administrative platforms.
