...
## Demo
![Subscriber Lifecycle Manager workflow showing automated email triggers and subscriber status updates](assets/image.png)
...
* [CRM Data Sync Agent](../crm-data-sync-agent/index.md) - Synchronizes subscriber and contact data across platforms.
* [Account Health Usage Monitor](../account-health-usage-monitor-by-jotform/index.md) - Tracks usage metrics to identify churn risks.
