...
## Demo
![Create CSV Agent from Scratch workflow interface showing data transformation nodes](assets/image.png)
...
* [CRM Data Hygiene Manager](../crm-data-hygiene-manager/index.md) - Automate data cleanup and formatting to ensure high-quality records.
* [Deal Pipeline Manager](../deal-pipeline-manager/index.md) - Manage and track sales pipeline stages for improved operational visibility.
