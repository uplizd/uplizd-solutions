...
## Demo
![Lead Intake Automator workflow diagram showing AgencyZoom lead capture, AI qualification, and CRM routing](assets/image.png)
...
- [Deal Pipeline Manager](../deal-pipeline-manager/index.md) - Manage and track deal stages after lead intake.
- [Account Intelligence Gatherer](../account-intelligence-gatherer-by-dropcontact/index.md) - Enrich lead data with external intelligence.
