...
## Demo
![Workflow diagram showing Chat Input, Agent, Mailchimp Composio Toolset, and Chat Output for automated email sequences](assets/image.png)
...
- [WhatsApp Lead Nurturing Agent](../whats-app-lead-nurturing-agent-by-spoki/index.md) - Extend your nurturing strategy to mobile messaging.
- [Account Intelligence Reporter](../account-intelligence-reporter-by-leadfeeder/index.md) - Gather insights to better segment your email lists.
