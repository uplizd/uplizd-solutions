...
## Demo
![File Asset Manager dashboard showing automated document categorization and metadata tagging workflow](assets/image.png)
...
* [Workflow Health Monitor](../workflow-health-monitor-by-dailybot/index.md) - Real-time tracking and reporting on the status of your automated processes.
* [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) - Streamlined onboarding and configuration for new accounts.
