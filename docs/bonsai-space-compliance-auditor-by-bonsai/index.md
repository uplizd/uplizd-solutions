...
## Demo
![Bonsai Space Compliance Auditor workflow interface showing automated policy check nodes and alert triggers](assets/image.png)
...
## Related Solutions
- [Account Audit Agent](../account-audit-agent-by-cloudflare/index.md) — Comprehensive audit and security monitoring for cloud accounts.
- [Admin User Access Auditor](../admin-user-access-auditor-by-storeganise/index.md) — Governance and permission tracking for administrative user roles.
- [Workflow Health Monitor](../workflow-health-monitor-by-dailybot/index.md) — Real-time monitoring and status reporting for automated business workflows.
