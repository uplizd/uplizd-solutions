...
## Demo
![Proposal Automation Agent workflow interface showing CRM data integration and document generation](assets/image.png)
...
## Related Solutions
- [Account Research Agent](../account-research-agent-by-onepage/index.md) — Gather deep intelligence on prospects before drafting proposals.
- [Deal Pipeline Manager](../deal-pipeline-manager/index.md) — Manage deal stages and track progress alongside your proposal workflows.
- [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) — Automate the initial setup of new accounts in your CRM.
