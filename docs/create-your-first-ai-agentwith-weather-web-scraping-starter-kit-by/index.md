...
## Demo
![AI Agent Starter Kit workflow showing Chat Input connected to an Agent node with Weather and Web Scraping tools](assets/image.png)
...
- [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) - Streamline complex business processes with agentic logic.
- [YouTube Insight Agent](../youtube-insight-agent-by/index.md) - Extract and analyze data from video content.
