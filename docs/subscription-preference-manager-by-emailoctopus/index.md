...
## Demo
![Subscription Preference Manager workflow showing EmailOctopus integration and automated preference updates](assets/image.png)
...
- [CRM Data Hygiene Manager](../crm-data-hygiene-manager/index.md) — Maintain clean, accurate data across your marketing stack.
- [WhatsApp Lead Nurturing Agent](../whats-app-lead-nurturing-agent-by-spoki/index.md) — Extend your communication strategy to mobile messaging.
