...
## Demo
![Employee Onboarding Automation Agent workflow diagram showing SharePoint integration](assets/image.png)
...
## Related Solutions
* [Admin User Onboarding Assistant](../admin-user-onboarding-assistant-by-storeganise/index.md) - Automates administrative user setup and access management.
* [Workforce Onboarding Automator](../workforce-onboarding-automator-by-connecteam/index.md) - Streamlines general workforce onboarding tasks and communication.
* [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) - General purpose automation for business process workflows.
