...
## Demo
![Customer Support Escalation Manager workflow diagram showing ticket intake, AI analysis, and routing to support agents](assets/image.png)
...
- [action-item-prioritizer-by-rootly](../action-item-prioritizer-by-rootly/index.md) - Prioritization engine for technical action items and incident response.
