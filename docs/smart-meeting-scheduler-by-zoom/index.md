...
## Demo
![Smart Meeting Scheduler workflow interface showing Zoom integration nodes and automated scheduling logic](assets/image.png)
...
## Related Solutions
- [Zoom Usage Intelligence Agent](../zoom-usage-intelligence-agent/index.md) — Analyze meeting patterns and attendance data.
- [Account Research Assistant](../account-research-assistant-by-zoominfo/index.md) — Gather prospect intelligence before scheduling meetings.
- [Action Item Prioritizer](../action-item-prioritizer-by-rootly/index.md) — Manage follow-up tasks generated during scheduled meetings.
