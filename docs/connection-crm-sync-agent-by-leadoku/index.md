...
## Demo
![Connection CRM Sync Agent workflow diagram showing data flow from connection source to CRM](assets/image.png)
...
*   [CRM Data Hygiene Manager](../crm-data-hygiene-manager/index.md) - Automated cleanup and formatting for CRM records.
*   [Account Research Agent](../account-research-agent-by-onepage/index.md) - Deep-dive intelligence gathering for target accounts.
*   [Deal Pipeline Manager](../deal-pipeline-manager/index.md) - Manage deal stages and follow-up cadences effectively.
