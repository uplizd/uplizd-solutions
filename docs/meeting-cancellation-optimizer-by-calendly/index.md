...
## Demo
![Meeting Cancellation Optimizer workflow screenshot showing the integration between Chat Input, Agent, Calendly Composio Toolset, and Chat Output](assets/image.png)
...
*   [Deal Pipeline Manager](../deal-pipeline-manager/index.md) — Manage sales stages and follow-up workflows.
*   [Workplace Risk Early Warning System](../workplace-risk-early-warning-system-by-faceup/index.md) — Monitor and manage operational risks.
