...
## Demo
![Customer Journey Mapper workflow showing event tracking and Mailchimp integration nodes](assets/image.png)
...
## Related Solutions
- [Abandoned Cart Recovery Agent](../abandoned-cart-recovery-agent-by-klaviyo/index.md) - Recovers lost revenue by automating follow-ups for unpurchased items.
- [CRM Data Sync Agent](../crm-data-sync-agent/index.md) - Synchronizes customer data across multiple platforms to maintain a single source of truth.
- [Account Intelligence Reporter](../account-intelligence-reporter-by-leadfeeder/index.md) - Aggregates account-level data to inform personalized marketing and sales outreach.
