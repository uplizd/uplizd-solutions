...
## Demo
![HR Onboarding Document Agent workflow diagram showing document distribution and signature tracking](assets/image.png)
...
## Related Solutions
- [Workforce Onboarding Automator](../workforce-onboarding-automator-by-connecteam/index.md) - Streamlines general workforce onboarding and team management.
- [Admin User Onboarding Assistant](../admin-user-onboarding-assistant-by-storeganise/index.md) - Automates the setup and onboarding for administrative user accounts.
- [Account Research Agent](../account-research-agent-by-onepage/index.md) - Gathers intelligence to support personalized onboarding and account setup.
