...
## Demo
![Expo Category Manager workflow interface showing automated category mapping and floor plan synchronization](assets/image.png)
...
## Related Solutions
- [Account Research Agent](../account-research-agent-by-onepage/index.md) - Automate account intelligence gathering for better exhibitor targeting.
- [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) - Streamline general operational tasks and data synchronization.
- [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) - Manage CRM-based account onboarding and data mapping.
