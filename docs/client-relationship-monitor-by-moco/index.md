...
## Demo
![Client Relationship Monitor workflow dashboard showing engagement scores and risk alerts](assets/image.png)
...
- [Deal Pipeline Manager](../deal-pipeline-manager/index.md) - Manage sales stages and pipeline velocity for active opportunities.
