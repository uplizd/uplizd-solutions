...
## Demo
![Interview Cleanup Assistant dashboard showing automated candidate record deduplication and status updates](assets/image.png)
...
* [CRM Data Hygiene Manager](../crm-data-hygiene-manager/index.md) - General-purpose data cleanup for broader CRM environments.
* [Deal Pipeline Manager](../deal-pipeline-manager/index.md) - Manages sales pipeline stages and stalled deal follow-ups.
