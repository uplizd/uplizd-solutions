...
## Demo
![GitLab Group Governance Agent workflow showing automated audit and permission update nodes](assets/image.png)
...
## Related Solutions
- [Account Audit Agent](../account-audit-agent-by-cloudflare/index.md) - Monitor and audit account-level security and access configurations.
- [Admin User Access Auditor](../admin-user-access-auditor-by-storeganise/index.md) - Track and report on administrative user permissions and activity.
