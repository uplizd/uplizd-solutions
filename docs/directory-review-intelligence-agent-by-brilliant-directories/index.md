...
## Demo
![Directory Review Intelligence Agent dashboard showing sentiment analysis and trend extraction](assets/image.png)
...
## Related Solutions
- [Account Intelligence Reporter](../account-intelligence-reporter-by-leadfeeder/index.md) — Aggregate account-level insights and signals for sales teams.
- [247 Customer Support Assistant](../247-customer-support-assistant-by-ai-ml-api/index.md) — Provide round-the-clock support automation for customer inquiries.
- [YouTube Audience Research Agent](../you-tube-audience-research-agent-by-youtube/index.md) — Analyze video feedback and audience sentiment at scale.
