...
## Demo
![Multi-Property Widget Manager workflow showing automated deployment of booking widgets across multiple property dashboards](assets/image.png)
...
## Related Solutions
- [Widget Experience Optimizer](../widget-experience-optimizer-by-productlane/index.md) — Enhance user engagement through data-driven widget adjustments.
- [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) — Streamline general operations and task management across your business.
- [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) — Automate the onboarding and configuration of new accounts and properties.
