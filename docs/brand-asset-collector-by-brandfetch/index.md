...
## Demo
![Brand Asset Collector workflow diagram showing Brandfetch integration and automated asset organization](assets/image.png)
...
## 🚀 Run on Uplizd
[![Run on Uplizd](https://img.shields.io/badge/Run_on-Uplizd-blue?logo=uplizd)](https://uplizd.ai/solutions/8472c8d2-a7ec-580a-a705-baf459171ab2)
...
- [Account Research Assistant](../account-research-assistant-by-zoominfo/index.md) — Deep-dive into company profiles and market positioning.
- [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) — Streamline operational tasks across project management platforms.
