...
## Demo
![Research Knowledge Curator workflow diagram showing Mem0 integration and data synthesis](assets/image.png)
...
- [Academic Impact Tracker](../academic-impact-tracker-by-semanticscholar/index.md) - Monitor and curate academic research performance.
- [YouTube Audience Research Agent](../you-tube-audience-research-agent-by-youtube/index.md) - Synthesize audience insights from video content.
