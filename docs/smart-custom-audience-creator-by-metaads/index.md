...
## Demo
![Smart Custom Audience Creator workflow diagram showing data ingestion, audience segmentation, and Meta Ads synchronization](assets/image.png)
...
## Related Solutions
*   [Abandoned Cart Recovery Agent](../abandoned-cart-recovery-agent-by-klaviyo/index.md) — Automate recovery workflows for lost revenue.
...
*   [CRM Data Sync Agent](../crm-data-sync-agent/index.md) — Keep customer data consistent across platforms.
