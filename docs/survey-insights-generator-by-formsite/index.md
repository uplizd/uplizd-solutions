...
## Demo
![Survey Insights Generator workflow dashboard showing data ingestion from Formsite and AI-generated sentiment reports](assets/image.png)
...
## Related Solutions
- [Account Intelligence Gatherer](../account-intelligence-gatherer-by-dropcontact/index.md) - Enrich customer profiles with external data.
- [Customer Support Triage Agent](../whats-app-support-triage-agent-by-wati/index.md) - Automate ticket routing based on sentiment.
- [AB Test Performance Analyzer](../ab-test-performance-analyzer-by-microsoft-clarity/index.md) - Evaluate user behavior and experiment outcomes.
