...
## Demo
![Document Cleanup Assistant workflow interface showing Dropbox integration and file scanning nodes](assets/image.png)
...
## Related Solutions
- [Account Audit Agent](../account-audit-agent-by-cloudflare/index.md) - Audit and monitor account-level configurations and security settings.
...
- [CRM Data Hygiene Manager](../crm-data-hygiene-manager/index.md) - Maintain clean CRM records by identifying and merging duplicate entries.
