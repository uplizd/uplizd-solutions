...
## Demo
![Portfolio Performance Monitor dashboard showing real-time asset tracking and performance analytics](assets/image.png)
...
- [Account Health Usage Monitor](../account-health-usage-monitor-by-jotform/index.md) — Tracks customer usage patterns and account health metrics.
- [Ad Trend Tracking Agent](../ad-trend-tracking-agent-by-adyntel/index.md) — Monitors advertising performance trends and market shifts.
