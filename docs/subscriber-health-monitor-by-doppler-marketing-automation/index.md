...
## Demo
![Subscriber Health Monitor dashboard showing automated list cleanup and engagement metrics](assets/image.png)
...
- [CRM Data Hygiene Manager](../crm-data-hygiene-manager/index.md) — Cleans and standardizes CRM contact data.
- [Account Health Usage Monitor](../account-health-usage-monitor-by-jotform/index.md) — Tracks customer usage to identify churn risks.
