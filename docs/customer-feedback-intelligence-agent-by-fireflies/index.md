...
## Demo
![Customer Feedback Intelligence Agent workflow dashboard showing Fireflies transcription and sentiment analysis nodes](assets/image.png)
...
## Related Solutions
* [247-customer-support-assistant-by-ai-ml-api](../247-customer-support-assistant-by-ai-ml-api/index.md) - General purpose support automation.
* [whats-app-feedback-collection-agent-by-wati](../whats-app-feedback-collection-agent-by-wati/index.md) - Collect feedback via WhatsApp channels.
* [account-intelligence-reporter-by-leadfeeder](../account-intelligence-reporter-by-leadfeeder/index.md) - Aggregate account insights for sales teams.
