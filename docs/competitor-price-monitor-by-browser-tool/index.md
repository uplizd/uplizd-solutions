...
## Demo
![Competitor Price Monitor workflow showing browser-based scraping and price analysis nodes](assets/image.png)
...
## 🚀 Run on Uplizd
[![Run on Uplizd](https://img.shields.io/badge/Run_on-Uplizd-blue?logo=uplizd)](https://uplizd.ai/solutions/bc017069-4c09-5736-8c4b-1a2840b2c9c1)
...
- [Account Research Assistant](../account-research-assistant-by-zoominfo/index.md) - Deep dive into competitor and prospect firmographics.
- [Workflow Health Monitor](../workflow-health-monitor-by-dailybot/index.md) - Track the performance and uptime of your automated agents.
