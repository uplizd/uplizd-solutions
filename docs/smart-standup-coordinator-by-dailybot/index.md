...
## Demo
![Smart Standup Coordinator workflow showing automated chat input, agent processing, and DailyBot integration](assets/image.png)
...
## Related Solutions
* [Workflow Health Monitor](../workflow-health-monitor-by-dailybot/index.md) - Track the efficiency and performance of your automated team workflows.
...
* [Action Item Cleanup Agent](../action-item-cleanup-agent-by-rootly/index.md) - Maintain hygiene in your task lists by identifying and closing stale items.
