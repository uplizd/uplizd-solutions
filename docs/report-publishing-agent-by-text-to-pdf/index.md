...
## Demo
![Report Publishing Agent workflow interface showing data input, AI processing, and PDF export nodes](assets/image.png)
...
- [Workflow Health Monitor](../workflow-health-monitor-by-dailybot/index.md) — Track and report on the performance of your automated workflows.
- [CRM Data Sync Agent](../crm-data-sync-agent/index.md) — Maintain data consistency across platforms to ensure accurate reporting.
