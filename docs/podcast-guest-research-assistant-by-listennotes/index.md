...
## Demo
![Podcast Guest Research Assistant workflow showing ListenNotes API integration for guest vetting](assets/image.png)
...
## Related Solutions
- [YouTube Audience Research Agent](../you-tube-audience-research-agent-by-youtube/index.md) — Analyze viewer trends and content performance on YouTube.
- [Account Research Agent](../account-research-agent-by-onepage/index.md) — Gather deep intelligence on business accounts and prospects.
- [Academic Impact Tracker](../academic-impact-tracker-by-semanticscholar/index.md) — Monitor research influence and academic guest credentials.
