...
## Demo
![Intelligent Response Processor workflow showing email categorization and routing logic](assets/image.png)
...
- [Action Item Prioritizer](../action-item-prioritizer-by-rootly/index.md) - Helps teams focus on the most critical tasks by prioritizing incoming action items.
