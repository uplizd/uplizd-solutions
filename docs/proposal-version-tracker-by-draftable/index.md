...
## Demo
![Proposal Version Tracker workflow interface showing document comparison and change logs](assets/image.png)
...
* [Deal Pipeline Manager](../deal-pipeline-manager/index.md) - Manage sales stages and deal velocity.
