...
## Demo
![Campaign Launch Assistant workflow interface showing automated Raisely configuration nodes](assets/image.png)
...
## Related Solutions
- [Abandoned Cart Recovery Agent](../abandoned-cart-recovery-agent-by-klaviyo/index.md) — Recover lost donations and donor interest.
- [Account Intelligence Gatherer](../account-intelligence-gatherer-by-dropcontact/index.md) — Enrich donor and account data for better targeting.
- [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) — Extend automation capabilities across your operational stack.
