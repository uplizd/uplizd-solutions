...
## Demo
![Inventory Reorder Advisor workflow dashboard showing automated stock level alerts and purchase order generation](assets/image.png)
...
- [Workspace Usage Analyzer](../workspace-usage-analyzer-by-baserow/index.md) — Monitor data usage and optimize resource allocation across your workspaces.
