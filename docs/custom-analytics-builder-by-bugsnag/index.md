...
## Demo
![Custom Analytics Builder workflow dashboard showing Bugsnag data integration and automated reporting nodes](assets/image.png)
...
## Related Solutions
- [Account Intelligence Reporter](../account-intelligence-reporter-by-leadfeeder/index.md) - Automate business intelligence gathering and reporting.
- [Workflow Health Monitor](../workflow-health-monitor-by-dailybot/index.md) - Track and report on the operational health of your automated pipelines.
- [Account Health Usage Monitor](../account-health-usage-monitor-by-jotform/index.md) - Monitor and analyze user engagement and account health metrics.
