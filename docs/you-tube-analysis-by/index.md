...
## Demo
![YouTube Analysis Agent workflow dashboard showing transcript extraction and sentiment analysis nodes](assets/image.png)
...
## Related Solutions
- [YouTube Audience Research Agent](../you-tube-audience-research-agent-by-youtube/index.md) — Identify and segment your target audience based on video interaction data.
- [YouTube Content Performance Optimizer](../you-tube-content-performance-optimizer-by-youtube/index.md) — Improve video reach and engagement through data-driven content adjustments.
- [YouTube Competitor Intelligence Agent](../you-tube-competitor-intelligence-agent-by-youtube/index.md) — Track and analyze competitor strategies to refine your own content roadmap.
