...
## Demo
![Team Pulse Analyzer dashboard showing sentiment trends and engagement metrics](assets/image.png)
...
- [Workplace Risk Early Warning System](../workplace-risk-early-warning-system-by-faceup/index.md) - Identify and mitigate organizational risks through proactive monitoring.
- [Workshop Facilitator Agent](../workshop-facilitator-agent-by-mural/index.md) - Streamline team collaboration and workshop outcomes.
