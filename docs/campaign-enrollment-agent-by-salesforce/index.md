...
## Demo
![Campaign Enrollment Agent workflow diagram showing CRM integration and automated lead routing](assets/image.png)
...
- [Deal Pipeline Manager](../deal-pipeline-manager/index.md) - Manages pipeline stages and automates follow-ups for stalled deals.
