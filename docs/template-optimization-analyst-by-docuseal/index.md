...
## Demo
![Template Optimization Analyst workflow interface showing DocuSeal integration and analysis nodes](assets/image.png)
...
## Related Solutions
*   [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) - Automates the configuration of new accounts in your CRM.
...
*   [Account Health Usage Monitor](../account-health-usage-monitor-by-jotform/index.md) - Tracks user engagement and account health metrics.
