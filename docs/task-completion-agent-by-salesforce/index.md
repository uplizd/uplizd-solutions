...
## Demo
![Task Completion Agent workflow interface showing automated Salesforce task updates and note synchronization](assets/image.png)
...
- [Deal Pipeline Manager](../deal-pipeline-manager/index.md) - Manages pipeline stages and identifies stalled deals for SalesOps.
- [CRM Data Hygiene Manager](../crm-data-hygiene-manager/index.md) - Cleans and standardizes CRM data to prevent decay and ensure compliance.
