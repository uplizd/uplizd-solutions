...
## Demo
![Agile Retrospective Analyzer workflow diagram showing Miro board integration, AI analysis, and summary report generation](assets/image.png)
...
## Related Solutions
* [Workshop Facilitator Agent](../workshop-facilitator-agent-by-mural/index.md) - Automate workshop agendas and participant engagement.
* [Workshop Template Curator](../workshop-template-curator-by-miro/index.md) - Manage and deploy standardized workshop templates.
* [Workflow Health Monitor](../workflow-health-monitor-by-dailybot/index.md) - Track team productivity and workflow bottlenecks.
