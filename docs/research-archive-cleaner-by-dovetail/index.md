...
## Demo
![Research Archive Cleaner workflow interface showing project filtering and archival status](assets/image.png)
...
- [Action Item Cleanup Agent](../action-item-cleanup-agent-by-rootly/index.md) - Maintains hygiene by resolving stale action items.
- [Workflow Health Monitor](../workflow-health-monitor-by-dailybot/index.md) - Tracks the operational status and efficiency of automated processes.
