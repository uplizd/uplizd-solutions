...
## Demo
![Lead Response Assistant workflow showing Gmail trigger, AI agent processing, and draft generation](assets/image.png)
...
- [Account Research Assistant](../account-research-assistant/index.md) - Gather intelligence on prospects to personalize outreach efforts.
