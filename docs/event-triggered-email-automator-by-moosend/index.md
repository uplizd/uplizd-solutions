...
## Demo
![Uplizd workflow diagram showing an event trigger connected to an email automation agent using Moosend](assets/image.png)
...
## Related Solutions
- [Abandoned Cart Recovery Agent (Klaviyo)](../abandoned-cart-recovery-agent-by-klaviyo/index.md) — Automate recovery sequences for e-commerce platforms.
- [WhatsApp Lead Nurturing Agent (Spoki)](../whats-app-lead-nurturing-agent-by-spoki/index.md) — Multi-channel lead engagement via WhatsApp.
- [Workflow Automation Agent (JobNimbus)](../workflow-automation-agent-by-jobnimbus/index.md) — General purpose business process automation.
