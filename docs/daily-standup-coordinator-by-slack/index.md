...
## Demo
![Daily Standup Coordinator workflow showing Slack integration for automated status collection](assets/image.png)
...
## Related Solutions
- [Workflow Health Monitor](../workflow-health-monitor-by-dailybot/index.md) - Track the operational efficiency of your automated team workflows.
- [Action Item Prioritizer](../action-item-prioritizer-by-rootly/index.md) - Automatically rank and assign tasks extracted from team communications.
- [Action Item Cleanup Agent](../action-item-cleanup-agent-by-rootly/index.md) - Maintain hygiene by archiving or resolving stale action items from your project boards.
