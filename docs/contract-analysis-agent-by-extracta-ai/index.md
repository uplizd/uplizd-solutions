...
## Demo
![Contract Analysis Agent workflow interface showing automated clause extraction and document summary](assets/image.png)
...
- [Action Item Prioritizer](../action-item-prioritizer-by-rootly/index.md) - Organize and rank tasks extracted from meeting or document notes.
