...
## Demo
![Estimate & Invoice Optimizer workflow showing automated document generation and RepairShopr integration](assets/image.png)
...
*   [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) - Streamline complex service-based project workflows.
*   [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) - Standardize customer onboarding and data entry processes.
