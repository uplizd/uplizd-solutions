...
## Demo
![WhatsApp Feedback Collection Agent interface showing an automated survey flow with a customer on WhatsApp](assets/image.png)
...
## Related Solutions
* [WhatsApp Lead Qualification Agent](../whats-app-lead-qualification-agent-by-whatsapp/index.md) - Automate lead scoring and qualification via WhatsApp.
* [WhatsApp Support Triage Agent](../whats-app-support-triage-agent-by-wati/index.md) - Efficiently route support tickets based on urgency and intent.
* [CRM Data Hygiene Manager](../crm-data-hygiene-manager/index.md) - Maintain clean, accurate contact data across your CRM ecosystem.
