...
## Demo
![Project Cleanup Assistant workflow showing automated Wrike task archiving and status updates](assets/image.png)
...
- [Workflow Health Monitor](../workflow-health-monitor-by-dailybot/index.md) - Track and maintain the health of your team's automated workflows.
- [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) - Streamline the creation and organization of new account structures.
