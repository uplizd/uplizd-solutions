...
## Demo
![Customer Journey Mapping Agent interface showing automated Mural board population from research data](assets/image.png)
...
## Related Solutions
- [Workshop Facilitator Agent](../workshop-facilitator-agent-by-mural/index.md) - Automate the setup and management of collaborative workshops in Mural.
- [Workshop Template Curator](../workshop-template-curator-by-miro/index.md) - Manage and deploy standardized workshop templates across your organization.
- [Account Research Agent](../account-research-agent-by-onepage/index.md) - Gather and synthesize account intelligence to inform your customer journey strategy.
