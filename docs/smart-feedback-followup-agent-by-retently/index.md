...
## Demo
![Smart Feedback Follow-up Agent workflow diagram showing Retently feedback analysis and automated response generation](assets/image.png)
...
## Related Solutions
- [247-customer-support-assistant-by-ai-ml-api](../247-customer-support-assistant-by-ai-ml-api/index.md) - AI-powered support assistant for 24/7 customer query resolution.
- [whats-app-feedback-collection-agent-by-wati](../whats-app-feedback-collection-agent-by-wati/index.md) - Collect customer feedback directly through WhatsApp channels.
- [account-health-usage-monitor-by-jotform](../account-health-usage-monitor-by-jotform/index.md) - Monitor account health and usage metrics to proactively manage customer satisfaction.
