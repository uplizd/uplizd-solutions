...
## Demo
![Environmental Health Monitor dashboard showing real-time air quality index and weather metrics](assets/image.png)
...
- [Account Health Usage Monitor](../account-health-usage-monitor-by-jotform/index.md) - Monitor account activity and usage metrics to ensure operational health.
- [Workplace Risk Early Warning System](../workplace-risk-early-warning-system-by-faceup/index.md) - Identify and mitigate risks in the workplace environment.
