...
## Demo
![Meeting Follow-up Assistant workflow diagram showing Zoom integration, AI summarization, and automated email distribution](assets/image.png)
...
## Related Solutions
- [Zoom Usage Intelligence Agent](../zoom-usage-intelligence-agent/index.md) - Analyze meeting frequency and participant engagement metrics.
- [Account Research Assistant](../account-research-assistant-by-zoominfo/index.md) - Enrich account data before and after client meetings.
- [Action Item Prioritizer](../action-item-prioritizer-by-rootly/index.md) - Organize and rank tasks extracted from various communication channels.
