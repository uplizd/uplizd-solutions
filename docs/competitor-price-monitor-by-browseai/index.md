...
## Demo
![Competitor Price Monitor workflow dashboard showing automated scraping nodes and price alert triggers](assets/image.png)
...
## 🚀 Run on Uplizd
[![Run on Uplizd](https://img.shields.io/badge/Run_on-Uplizd-blue?logo=uplizd)](https://uplizd.ai/solutions/033458dc-003a-5949-9531-faf862f499f1)
...
- [Account Research Agent](../account-research-agent-by-onepage/index.md) - Automate deep-dive research into competitor accounts.
- [Ad Trend Tracking Agent](../ad-trend-tracking-agent-by-adyntel/index.md) - Monitor competitor advertising and market positioning trends.
