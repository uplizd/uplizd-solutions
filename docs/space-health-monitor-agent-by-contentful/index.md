...
## Demo
![Space Health Monitor Agent workflow dashboard showing Contentful integration and health status alerts](assets/image.png)
...
## Related Solutions
- [Account Health Usage Monitor](../account-health-usage-monitor-by-jotform/index.md) — Track account usage metrics and health indicators.
...
- [Account Audit Agent](../account-audit-agent-by-cloudflare/index.md) — Perform deep-level security and configuration audits on your accounts.
