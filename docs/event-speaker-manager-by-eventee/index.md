...
## Demo
![Event Speaker Manager workflow dashboard showing automated speaker data synchronization and session assignment](assets/image.png)
...
- [Workforce Onboarding Automator](../workforce-onboarding-automator-by-connecteam/index.md) - Streamline team member onboarding and data management.
