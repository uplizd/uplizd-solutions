...
## Demo
![Pipeline Health Dashboard Generator workflow interface showing Buildkite data integration and automated reporting](assets/image.png)
...
## Related Solutions
- [Workflow Health Monitor](../workflow-health-monitor-by-dailybot/index.md) — Monitor general team workflow health and daily stand-up metrics.
- [Account Health Usage Monitor](../account-health-usage-monitor-by-jotform/index.md) — Track account-level usage and health signals for customer success.
