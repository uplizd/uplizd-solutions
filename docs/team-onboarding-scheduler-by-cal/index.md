...
## Demo
![Team Onboarding Scheduler workflow showing calendar integration and automated meeting invites](assets/image.png)
...
## Related Solutions
- [Workforce Onboarding Automator](../workforce-onboarding-automator/index.md) - End-to-end employee lifecycle and onboarding management.
- [Admin User Onboarding Assistant](../admin-user-onboarding-assistant-by-storeganise/index.md) - Streamlined access provisioning and user setup.
- [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) - Automated CRM account creation and configuration.
