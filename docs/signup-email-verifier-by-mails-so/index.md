...
## Demo
![Signup Email Verifier workflow showing Chat Input, Agent, Mails.so toolset, and Chat Output nodes](assets/image.png)
...
* [CRM Data Hygiene Manager](../crm-data-hygiene-manager/index.md) — Automate bulk cleanup of decayed CRM records.
* [Account Research Assistant](../account-research-assistant-by-zoominfo/index.md) — Deep research for high-value account identification.
