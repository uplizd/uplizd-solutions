...
## Demo
![Financial Anomaly Detection System workflow showing data ingestion from Google BigQuery, anomaly analysis, and alert generation](assets/image.png)
...
## 🚀 Run on Uplizd
[![Run on Uplizd](https://img.shields.io/badge/Run_on-Uplizd-blue?logo=uplizd)](https://uplizd.ai/solutions/67186053-93af-5e86-a595-fa0687572d30)
...
## Related Solutions
- [Account Reconciliation Helper](../account-reconciliation-helper-by-quickbooks/index.md) — Automate the matching of financial records and bank statements.
- [Account Health Usage Monitor](../account-health-usage-monitor-by-jotform/index.md) — Track account activity and usage metrics for operational insights.
- [Workflow Health Monitor](../workflow-health-monitor-by-dailybot/index.md) — Monitor the operational status of your automated business processes.
