...
## Demo
![Canvas Course Setup Automation workflow interface showing automated module and assignment creation](assets/image.png)
...
## Related Solutions
* [Account Setup Agent (Salesforce)](../account-setup-agent-by-salesforce/index.md) - Automate CRM account provisioning and data entry.
* [Workflow Automation Agent (JobNimbus)](../workflow-automation-agent-by-jobnimbus/index.md) - Streamline business process automation for project management.
* [Workforce Onboarding Automator (Connecteam)](../workforce-onboarding-automator-by-connecteam/index.md) - Automate employee onboarding and resource provisioning workflows.
