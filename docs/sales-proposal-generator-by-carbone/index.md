...
## Demo
![Sales Proposal Generator workflow interface showing data mapping from CRM to Carbone document templates](assets/image.png)
...
* [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) — Automate the creation of CRM records once a proposal is accepted.
* [Deal Pipeline Manager](../deal-pipeline-manager/index.md) — Track the status of deals as proposals move through the sales cycle.
