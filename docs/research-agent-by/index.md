...
## Demo
![Research Agent workflow interface showing automated search planning and report generation](assets/image.png)
...
## Related Solutions
- [Account Research Agent](../account-research-agent-by-onepage/index.md) - Specialized agent for gathering deep intelligence on specific business accounts.
- [Account Intelligence Gatherer](../account-intelligence-gatherer-by-dropcontact/index.md) - Automated tool for enriching account data and contact information.
- [YouTube Analysis](../you-tube-analysis-by/index.md) - Agent for extracting insights and summaries from video content.
