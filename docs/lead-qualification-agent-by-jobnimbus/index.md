...
## Demo
![Lead Qualification Agent workflow diagram showing Chat Input, Agent, JobNimbus integration, and Chat Output](assets/image.png)
...
## Related Solutions
* [Workflow Automation Agent (JobNimbus)](../workflow-automation-agent-by-jobnimbus/index.md) — Automate general business processes and task management.
* [Account Setup Agent (Salesforce)](../account-setup-agent-by-salesforce/index.md) — Streamline new account creation and onboarding workflows.
