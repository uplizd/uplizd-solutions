...
## Demo
![Knowledge Retrieval Agent workflow interface showing vector search query and document extraction](assets/image.png)
...
- [CRM Data Sync Agent](../crm-data-sync-agent/index.md) - Maintain data consistency across your CRM and external platforms.
- [Action Item Prioritizer](../action-item-prioritizer-by-rootly/index.md) - Organize and rank tasks extracted from meeting notes and docs.
