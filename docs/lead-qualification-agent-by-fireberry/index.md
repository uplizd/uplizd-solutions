...
## Demo
![Lead Qualification Agent workflow showing CRM integration and automated scoring logic](assets/image.png)
...
* [Deal Pipeline Manager](../deal-pipeline-manager/index.md) — Manage and track the progress of qualified opportunities.
