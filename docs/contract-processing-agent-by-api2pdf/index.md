...
## Demo
![Contract Processing Agent workflow interface showing document ingestion, PDF conversion, and storage nodes](assets/image.png)
...
## Related Solutions
- [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) — Streamline client onboarding and account configuration.
- [Account Research Agent](../account-research-agent-by-onepage/index.md) — Gather intelligence on new accounts to inform contract terms.
