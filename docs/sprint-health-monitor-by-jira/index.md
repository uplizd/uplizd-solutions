...
## Demo
![Sprint Health Monitor dashboard showing real-time Jira ticket status and risk alerts](assets/image.png)
...
## Related Solutions
* [Workflow Health Monitor by Dailybot](../workflow-health-monitor-by-dailybot/index.md) - Track general team workflow efficiency and daily stand-up metrics.
* [Action Item Prioritizer by Rootly](../action-item-prioritizer-by-rootly/index.md) - Manage and rank incident response tasks and action items.
* [Account Health Usage Monitor by Jotform](../account-health-usage-monitor-by-jotform/index.md) - Monitor customer account health and usage metrics for success teams.
