...
## Demo
![Smart Lead Segmentation Agent workflow interface showing SendFox integration nodes and AI categorization logic](assets/image.png)
...
## Related Solutions
- [Abandoned Cart Recovery Agent](../abandoned-cart-recovery-agent-by-klaviyo/index.md) - Recovers lost revenue through automated email triggers.
- [Account Intelligence Reporter](../account-intelligence-reporter-by-leadfeeder/index.md) - Gathers insights on account activity to inform sales outreach.
- [CRM Data Sync Agent](../crm-data-sync-agent/index.md) - Synchronizes contact data across multiple platforms for a single source of truth.
