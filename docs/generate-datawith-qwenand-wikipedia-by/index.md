...
## Demo
![Workflow diagram showing Chat Input connected to a Qwen Agent, a Wikipedia Composio Toolset, and a final Chat Output node.](assets/image.png)
...
- [Academic Writing Precision Assistant](../academic-writing-precision-assistant-by-dictionary-api/index.md) — Refine technical and academic language.
- [Adaptive Learning Curriculum Builder](../adaptive-learning-curriculum-builder-by-perplexityai/index.md) — Create structured educational paths using AI.
