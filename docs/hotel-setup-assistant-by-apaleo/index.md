...
## Demo
![Hotel Setup Assistant workflow showing property data ingestion and Apaleo configuration nodes](assets/image.png)
...
- [Workflow Automation Agent (JobNimbus)](../workflow-automation-agent-by-jobnimbus/index.md) - Streamline operational workflows and task assignments.
- [Account Health Usage Monitor (Jotform)](../account-health-usage-monitor-by-jotform/index.md) - Track and report on account configuration health.
