...
## Demo
![Content Curation Bot workflow diagram showing Discord input, AI processing, and content organization](assets/image.png)
...
* [../whats-app-feedback-collection-agent-by-wati/README.md](../whats-app-feedback-collection-agent-by-wati/index.md) — Collect and organize user feedback from WhatsApp conversations.
* [../247-customer-support-assistant-by-ai-ml-api/README.md](../247-customer-support-assistant-by-ai-ml-api/index.md) — Provide 24/7 automated support responses based on community knowledge.
