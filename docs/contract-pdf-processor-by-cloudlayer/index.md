...
## Demo
![Contract PDF Processor workflow interface showing document generation and conversion nodes](assets/image.png)
...
## Related Solutions
*   [Account Research Agent](../account-research-agent-by-onepage/index.md) - Automate deep-dive research on prospects before generating contracts.
*   [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) - Sync contract data back to Salesforce once the PDF is finalized.
*   [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) - Manage end-to-end business process triggers for document generation.
