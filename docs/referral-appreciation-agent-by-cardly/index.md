...
## Demo
![Referral Appreciation Agent workflow showing CRM trigger to Cardly dispatch](assets/image.png)
...
## Related Solutions
- [../crm-data-sync-agent/README.md](../crm-data-sync-agent/index.md) - Synchronize and clean CRM data across multiple platforms.
- [../deal-pipeline-manager/README.md](../deal-pipeline-manager/index.md) - Manage deal stages and automate follow-up cadences.
- [../account-relationship-builder-by-dynamics365/README.md](../account-relationship-builder-by-dynamics365/index.md) - Strengthen account relationships using Dynamics 365 insights.
