...
## Demo
![Contract Template Manager workflow showing Documint integration and automated document generation](assets/image.png)
...
## Related Solutions
- [Account Research Agent](../account-research-agent-by-onepage/index.md) - Gather deep intelligence on accounts before drafting contracts.
- [Account Relationship Builder](../account-relationship-builder-by-dynamics365/index.md) - Manage complex client relationships and associated documentation.
- [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) - Automate broader business processes beyond document generation.
