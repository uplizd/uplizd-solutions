...
## Demo
![Employee Onboarding Document Agent workflow showing automated DocuSign integration for new hire paperwork](assets/image.png)
...
* [Admin User Onboarding Assistant](../admin-user-onboarding-assistant-by-storeganise/index.md) - Automate administrative access and setup for new users.
* [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) - Manage account provisioning and CRM record creation.
