...
## Demo
![Competitive Intelligence Agent workflow dashboard showing Hunter integration and data extraction nodes](assets/image.png)
...
- [Account Research Assistant](../account-research-assistant-by-zoominfo/index.md) - Deep-dive research into prospect organizations using ZoomInfo.
