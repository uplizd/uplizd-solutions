...
## Demo
![Knowledge Base Curator workflow diagram showing document ingestion and AI-powered retrieval](assets/image.png)
...
## Related Solutions
* [Workshop Template Curator (Miro)](../workshop-template-curator-by-miro/index.md) — Organize and deploy collaborative workshop templates.
* [Workflow Health Monitor (DailyBot)](../workflow-health-monitor-by-dailybot/index.md) — Track the status and efficiency of your team's operational workflows.
* [Account Intelligence Reporter (Leadfeeder)](../account-intelligence-reporter-by-leadfeeder/index.md) — Aggregate and report on account-level data for sales and marketing teams.
