...
## Demo
![Contract Approval Tracker workflow dashboard showing pending and approved document status updates](assets/image.png)
...
- [Action Item Prioritizer](../action-item-prioritizer-by-rootly/index.md) — Organize and prioritize tasks derived from document reviews.
