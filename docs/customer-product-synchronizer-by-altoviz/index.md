...
## Demo
![Customer Product Synchronizer workflow interface showing data flow between CRM and product catalog nodes](assets/image.png)
...
- [CRM Data Sync Agent](../crm-data-sync-agent/index.md) - Manages multi-platform synchronization and conflict resolution.
- [Deal Pipeline Manager](../deal-pipeline-manager/index.md) - Tracks and optimizes sales pipeline stages and follow-ups.
