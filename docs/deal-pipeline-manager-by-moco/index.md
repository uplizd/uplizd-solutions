...
## Demo
![Deal Pipeline Manager workflow dashboard showing automated stage transition triggers and CRM integration nodes](assets/image.png)
...
- [Deal Opportunity Tracker](../deal-opportunity-tracker/index.md) - Identify and score high-potential sales opportunities.
