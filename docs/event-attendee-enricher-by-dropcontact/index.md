...
## Demo
![Event Attendee Enricher workflow showing data flow from registration input to Dropcontact enrichment and CRM update](assets/image.png)
...
## Related Solutions
- [Account Intelligence Gatherer](../account-intelligence-gatherer-by-dropcontact/index.md) - Deep-dive research for target accounts using Dropcontact.
- [CRM Data Hygiene Manager](../crm-data-hygiene-manager/index.md) - Automated cleanup and deduplication for CRM databases.
- [Account Research Agent](../account-research-agent-by-onepage/index.md) - Automated account profiling and research workflows.
