...
## Demo
![Client Onboarding Workflow dashboard showing automated Trello card creation and status updates](assets/image.png)
...
- [Workflow Health Monitor](../workflow-health-monitor-by-dailybot/index.md) - Tracks team productivity and identifies bottlenecks in your processes.
- [Workforce Onboarding Automator](../workforce-onboarding-automator-by-connecteam/index.md) - Streamlines internal employee onboarding and documentation.
