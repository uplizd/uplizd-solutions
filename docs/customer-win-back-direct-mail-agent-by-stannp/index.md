...
## Demo
![Customer Win-Back Direct Mail Agent workflow diagram showing CRM data triggering Stannp postcard generation](assets/image.png)
...
## Related Solutions
- [Abandoned Cart Recovery Agent](../abandoned-cart-recovery-agent-by-klaviyo/index.md) - Automates follow-ups for incomplete purchases.
- [Account Intelligence Gatherer](../account-intelligence-gatherer-by-dropcontact/index.md) - Enriches CRM data for better targeting.
- [WhatsApp Lead Nurturing Agent](../whats-app-lead-nurturing-agent-by-spoki/index.md) - Multi-channel engagement for active leads.
