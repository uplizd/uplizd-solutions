...
## Demo
![Amplitude Cohort Manager workflow showing user segment ingestion and Amplitude API synchronization](assets/image.png)
...
## Related Solutions
- [../ab-test-optimizer-by-mixpanel/README.md](../ab-test-optimizer-by-mixpanel/index.md) - Optimize A/B test workflows and user segmentation.
