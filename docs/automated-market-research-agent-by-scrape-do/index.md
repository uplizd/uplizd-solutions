...
## Demo
![Automated Market Research Agent workflow showing web scraping and data synthesis nodes](assets/image.png)
...
## Related Solutions
- [Account Research Agent](../account-research-agent-by-onepage/index.md) - Deep-dive intelligence on specific business accounts.
- [Account Intelligence Reporter](../account-intelligence-reporter-by-leadfeeder/index.md) - Automated reporting on account activity and engagement.
- [YouTube Audience Research Agent](../you-tube-audience-research-agent-by-youtube/index.md) - Extracting market signals from video content and audience feedback.
