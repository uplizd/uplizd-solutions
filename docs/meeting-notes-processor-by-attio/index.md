...
## Demo
![Meeting Notes Processor workflow diagram showing transcript input, AI analysis, and CRM update](assets/image.png)
...
* [Deal Pipeline Manager](../deal-pipeline-manager/index.md) — Manage pipeline stages and track stalled deals effectively.
* [Account Intelligence Gatherer](../account-intelligence-gatherer/index.md) — Enrich account records with external data and insights.
