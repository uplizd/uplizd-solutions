...
## Demo
![Incident Response Orchestrator workflow showing automated alert triage and escalation to Better Stack](assets/image.png)
...
## Related Solutions
- [Action Item Cleanup Agent](../action-item-cleanup-agent-by-rootly/index.md) - Automates the cleanup and organization of incident-related action items.
- [Action Item Prioritizer](../action-item-prioritizer-by-rootly/index.md) - Ranks and assigns follow-up tasks generated during incident response.
