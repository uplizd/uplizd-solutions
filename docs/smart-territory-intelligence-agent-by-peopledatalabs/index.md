...
## Demo
![Smart Territory Intelligence Agent workflow showing data enrichment from PeopleDataLabs to CRM](assets/image.png)
...
## Related Solutions
- [Account Intelligence Gatherer](../account-intelligence-gatherer-by-dropcontact/index.md) - Enrich account data using Dropcontact.
- [Account Research Agent](../account-research-agent-by-onepage/index.md) - Deep research on target accounts for sales teams.
- [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) - Automate the creation and configuration of new accounts in Salesforce.
- [Account Relationship Builder](../account-relationship-builder-by-dynamics365/index.md) - Manage and map complex account hierarchies in Dynamics 365.
