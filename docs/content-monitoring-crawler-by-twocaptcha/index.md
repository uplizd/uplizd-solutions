...
## Demo
![Content Monitoring Crawler workflow showing Chat Input, Agent, TwoCaptcha-enabled Composio Toolset, and Chat Output nodes](assets/image.png)
...
- [Account Intelligence Reporter](../account-intelligence-reporter-by-leadfeeder/index.md) — Generate comprehensive reports on account activities.
- [YouTube Competitor Intelligence Agent](../you-tube-competitor-intelligence-agent-by-youtube/index.md) — Track competitor performance and trends on YouTube.
