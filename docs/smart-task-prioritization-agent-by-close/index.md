...
## Demo
![Smart Task Prioritization Agent workflow in Uplizd builder showing CRM integration](assets/image.png)
...
- [Account Research Agent](../account-research-agent-by-onepage/index.md) - Gather deep intelligence on target accounts.
