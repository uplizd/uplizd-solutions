...
## Demo
![Partnership Credential Coordinator workflow showing automated certificate verification and partner notification steps](assets/image.png)
...
## Related Solutions
- [Account Relationship Builder](../account-relationship-builder-by-dynamics365/index.md) - Manage and track complex B2B partner and client relationships.
- [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) - Automate the initial configuration and data entry for new partner accounts.
- [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) - Extend your operational capabilities with custom automated business processes.
