...
## Demo
![Crypto Tax Preparation Assistant workflow interface showing data aggregation from Coinbase and wallet connections](assets/image.png)
...
- [Account Intelligence Reporter](../account-intelligence-reporter-by-leadfeeder/index.md) - Aggregate and report on account-level data insights.
- [Workflow Health Monitor](../workflow-health-monitor-by-dailybot/index.md) - Track the status and performance of automated data pipelines.
