...
## Demo
![Speaker Replacement Assistant workflow showing automated speaker search and booking integration](assets/image.png)
...
## Related Solutions
- [Workshop Facilitator Agent](../workshop-facilitator-agent-by-mural/index.md) - Manage collaborative session logistics and participant engagement.
- [Workforce Onboarding Automator](../workforce-onboarding-automator-by-connecteam/index.md) - Streamline the onboarding of new event staff and support personnel.
- [Account Research Assistant](../account-research-assistant-by-zoominfo/index.md) - Gather detailed intelligence on potential speakers or industry experts.
