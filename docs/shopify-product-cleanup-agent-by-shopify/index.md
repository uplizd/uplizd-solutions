...
## Demo
![Shopify Product Cleanup Agent workflow interface showing automated catalog audit and deletion of stale listings](assets/image.png)
...
- [Account Reconciliation Helper](../account-reconciliation-helper-by-quickbooks/index.md) - Syncs financial data and inventory records.
