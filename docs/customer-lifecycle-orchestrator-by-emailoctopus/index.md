...
## Demo
![Customer Lifecycle Orchestrator workflow showing EmailOctopus integration and lifecycle stage triggers](assets/image.png)
...
## Related Solutions
* [Abandoned Cart Recovery Agent](../abandoned-cart-recovery-agent-by-klaviyo/index.md) — Automates recovery emails for incomplete purchases.
* [Account Health Usage Monitor](../account-health-usage-monitor-by-jotform/index.md) — Tracks user activity to identify health trends.
