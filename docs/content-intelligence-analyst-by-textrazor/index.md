...
## Demo
![Content Intelligence Analyst workflow showing TextRazor integration for semantic data extraction](assets/image.png)
...
- [Account Intelligence Reporter](../account-intelligence-reporter-by-leadfeeder/index.md) - Generate automated reports on account activity.
- [YouTube Content Distribution Agent](../you-tube-content-distribution-agent-by-youtube/index.md) - Automate the distribution of video content assets.
