...
## Demo
![Smart Proposal Generator workflow dashboard showing CRM data integration and PandaDoc document generation](assets/image.png)
...
- [Deal Pipeline Manager](../deal-pipeline-manager/index.md) - Track and optimize deal stages and pipeline velocity.
- [Account Research Assistant](../account-research-assistant-by-zoominfo/index.md) - Gather deep intelligence on prospects to inform proposal content.
