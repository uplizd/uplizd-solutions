...
## Demo
![Search Agent workflow interface showing web search integration and AI synthesis](assets/image.png)
...
## Related Solutions
- [Account Research Agent](../account-research-agent-by-onepage/index.md) - Deep-dive research for specific business accounts.
- [Account Intelligence Reporter](../account-intelligence-reporter-by-leadfeeder/index.md) - Automated reporting on account-level engagement data.
- [YouTube Audience Research Agent](../you-tube-audience-research-agent-by-youtube/index.md) - Specialized research for video content and audience demographics.
