...
## Demo
![Shopify Collection Optimizer workflow showing product analysis and automated collection assignment](assets/image.png)
...
## Related Solutions
- [Abandoned Cart Recovery Agent](../abandoned-cart-recovery-agent-by-klaviyo/index.md) - Recover lost revenue with automated email and SMS follow-ups.
...
- [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) - Automate the onboarding and configuration of new client accounts.
