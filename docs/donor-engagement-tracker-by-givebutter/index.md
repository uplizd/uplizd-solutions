...
## Demo
![Donor Engagement Tracker workflow dashboard showing Givebutter integration and automated donor follow-up triggers](assets/image.png)
...
- [CRM Data Sync Agent](../crm-data-sync-agent/index.md) — Ensure multi-platform data consistency across your fundraising stack.
- [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) — Extend your operational automation beyond donor management.
