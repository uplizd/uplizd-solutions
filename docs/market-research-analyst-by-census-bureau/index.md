...
## Demo
![Market Research Analyst workflow dashboard showing data extraction from Census Bureau APIs and AI-generated summary report](assets/image.png)
...
## Related Solutions
- [Account Research Agent](../account-research-agent-by-onepage/index.md) — Automates deep-dive research on specific business accounts.
- [Account Intelligence Reporter](../account-intelligence-reporter-by-leadfeeder/index.md) — Generates comprehensive intelligence reports for sales teams.
- [YouTube Audience Research Agent](../you-tube-audience-research-agent-by-youtube/index.md) — Analyzes viewer demographics and content performance metrics.
