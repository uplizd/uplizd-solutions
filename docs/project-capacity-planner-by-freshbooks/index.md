...
## Demo
![Project Capacity Planner workflow showing resource allocation and FreshBooks project integration](assets/image.png)
...
* [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) — Streamline operational tasks and project workflows.
* [Workforce Onboarding Automator](../workforce-onboarding-automator-by-connecteam/index.md) — Manage new hire integration and resource provisioning.
