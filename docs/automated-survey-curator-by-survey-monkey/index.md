...
## Demo
![Automated Survey Curator workflow dashboard showing SurveyMonkey integration and data processing nodes](assets/image.png)
...
- [Customer Support Ticket Manager](../whats-app-support-ticket-manager-by-spoki/index.md) — Manage support tickets across communication channels.
