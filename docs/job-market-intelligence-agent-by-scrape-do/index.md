...
## Demo
![Job Market Intelligence Agent workflow showing Scrape.do data extraction and AI analysis](assets/image.png)
...
## Related Solutions
- [Account Research Agent](../account-research-agent-by-onepage/index.md) - Deep-dive intelligence on specific target accounts.
...
- [Account Research Assistant](../account-research-assistant-by-zoominfo/index.md) - Comprehensive prospect and company data gathering.
