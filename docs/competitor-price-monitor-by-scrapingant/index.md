...
## Demo
![Competitor Price Monitor workflow showing ScrapingAnt data extraction and AI analysis](assets/image.png)
...
* [Account Research Agent](../account-research-agent-by-onepage/index.md) - Automate deep-dive research into prospect accounts.
* [Ad Trend Tracking Agent](../ad-trend-tracking-agent-by-adyntel/index.md) - Monitor competitor advertising and promotional trends.
