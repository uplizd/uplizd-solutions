...
## Demo
![Neon Resource Cost Optimizer dashboard showing automated scaling events and cost savings metrics](assets/image.png)
...
- [Workspace Usage Analyzer](../workspace-usage-analyzer-by-baserow/index.md) — Analyzes resource consumption and usage patterns across team workspaces.
