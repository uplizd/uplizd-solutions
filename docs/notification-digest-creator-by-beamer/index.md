...
## Demo
![Notification Digest Creator workflow dashboard showing automated aggregation of unread alerts into a weekly summary email](assets/image.png)
...
## Related Solutions
- [Workflow Health Monitor](../workflow-health-monitor-by-dailybot/index.md) - Track the status and performance of your automated workflows.
- [Action Item Prioritizer](../action-item-prioritizer-by-rootly/index.md) - Automatically rank and assign tasks extracted from your communications.
- [WhatsApp Support Triage Agent](../whats-app-support-triage-agent-by-wati/index.md) - Manage and categorize incoming support tickets from messaging platforms.
