...
## Demo
![Certification Program Manager workflow showing enrollment, curriculum tracking, and Accredible credential issuance](assets/image.png)
...
## Related Solutions
- [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) - Automate new account onboarding and data entry.
...
- [Admin User Onboarding Assistant](../admin-user-onboarding-assistant-by-storeganise/index.md) - Streamline user access and administrative setup tasks.
