...
## Demo
![Seasonal Demand Forecaster workflow dashboard showing trend analysis and inventory recommendations](assets/image.png)
...
*   [Workflow Health Monitor](../workflow-health-monitor-by-dailybot/index.md) — Track the performance and reliability of your automated operations.
