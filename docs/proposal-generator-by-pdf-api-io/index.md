...
## Demo
![Proposal Generator workflow interface showing PDF data extraction and document assembly](assets/image.png)
...
## Related Solutions
*   [Account Research Agent](../account-research-agent-by-onepage/index.md) — Gather deep intelligence on accounts before generating proposals.
*   [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) — Automate the creation of new client records in your CRM.
*   [Deal Pipeline Manager](../deal-pipeline-manager/index.md) — Manage the lifecycle of deals that require proposal generation.
