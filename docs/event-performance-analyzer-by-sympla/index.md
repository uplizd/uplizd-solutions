...
## Demo
![Event Performance Analyzer dashboard showing attendee metrics and ticket sales data](assets/image.png)
...
- [Affiliate Performance Monitor](../affiliate-performance-monitor-by-tapfiliate/index.md) — Track and optimize affiliate marketing performance.
- [YouTube Content Performance Optimizer](../you-tube-content-performance-optimizer-by-youtube/index.md) — Analyze and improve video content metrics.
