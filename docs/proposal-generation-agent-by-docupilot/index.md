...
## Demo
![Proposal Generation Agent workflow diagram showing CRM data input to DocuPilot document creation](assets/image.png)
...
## Related Solutions
- [Account Research Assistant](../account-research-assistant-by-zoominfo/index.md) — Gather deep intelligence on prospects before generating proposals.
- [Deal Pipeline Manager](../deal-pipeline-manager/index.md) — Manage the lifecycle of opportunities from lead to closed-won.
- [CRM Data Sync Agent](../crm-data-sync-agent/index.md) — Maintain consistent lead and opportunity data across your entire tech stack.
