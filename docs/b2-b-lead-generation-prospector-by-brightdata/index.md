...
## Demo
![B2B Lead Generation Prospector workflow interface showing lead extraction and qualification nodes](assets/image.png)
...
- [CRM Data Sync Agent](../crm-data-sync-agent/index.md) - Keep your lead data consistent across multiple platforms.
- [Deal Opportunity Tracker](../deal-opportunity-tracker/index.md) - Monitor and score opportunities as they move through the pipeline.
