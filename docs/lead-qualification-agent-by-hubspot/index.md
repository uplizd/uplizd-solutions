...
## Demo
![Lead Qualification Agent workflow diagram showing HubSpot integration and automated scoring logic](assets/image.png)
...
- [Deal Pipeline Manager](../deal-pipeline-manager/index.md) — Manage and optimize sales pipeline stages and follow-ups.
- [CRM Data Sync Agent](../crm-data-sync-agent/index.md) — Synchronize lead and contact data across multiple CRM platforms.
- [CRM Data Hygiene Manager](../crm-data-hygiene-manager/index.md) — Maintain clean and compliant CRM records through automated cleanup.
