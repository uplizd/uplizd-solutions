...
## Demo
![Domain Security Monitor workflow dashboard showing automated DNS lookup and security alert triggers](assets/image.png)
...
## Related Solutions
* [Account Audit Agent by Cloudflare](../account-audit-agent-by-cloudflare/index.md) - Automates security audits for Cloudflare-managed infrastructure.
* [Zone Provisioning Agent by Cloudflare](../zone-provisioning-agent-by-cloudflare/index.md) - Manages and automates the provisioning of new security zones.
* [Account Health Compliance Monitor by Brevo](../account-health-compliance-monitor-by-brevo/index.md) - Monitors account-level compliance and health metrics.
