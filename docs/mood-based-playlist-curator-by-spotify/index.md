...
## Demo
![Mood-Based Playlist Curator workflow showing Chat Input, Agent, Composio Toolset, and Chat Output nodes](assets/image.png)
...
## Related Solutions
- [Workout Music Optimizer (Spotify)](../workout-music-optimizer-by-spotify/index.md) — Automate the creation of high-energy music sets for fitness routines.
...
- [Account Intelligence Gatherer](../account-intelligence-gatherer-by-dropcontact/index.md) — Enrich your CRM data with external account insights.
