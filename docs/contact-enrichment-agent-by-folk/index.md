...
## Demo
![Contact Enrichment Agent workflow showing automated data population from Folk CRM to external intelligence sources](assets/image.png)
...
## Related Solutions
- [Account Intelligence Gatherer](../account-intelligence-gatherer-by-dropcontact/index.md) - Automate the collection of deep account insights for better targeting.
- [Account Research Agent](../account-research-agent-by-onepage/index.md) - Streamline account-level research to support complex sales cycles.
- [CRM Data Hygiene Manager](../crm-data-hygiene-manager/index.md) - Maintain clean and compliant CRM databases through automated cleanup.
