...
## Demo
![Content Audit Agent workflow interface showing Contentful integration and AI analysis nodes](assets/image.png)
...
## Related Solutions
- [Account Research Agent](../account-research-agent-by-onepage/index.md) - Automates gathering and organizing account intelligence.
- [Workflow Health Monitor](../workflow-health-monitor-by-dailybot/index.md) - Tracks and reports on the operational status of automated workflows.
- [Account Intelligence Reporter](../account-intelligence-reporter-by-leadfeeder/index.md) - Aggregates and reports on account-level data for sales and marketing teams.
