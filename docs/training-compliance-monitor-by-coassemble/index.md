...
## Demo
![Training Compliance Monitor dashboard showing real-time employee course completion status and automated alert triggers](assets/image.png)
...
- [Account Health Compliance Monitor](../account-health-compliance-monitor-by-brevo/index.md) - Track and report on account-level compliance metrics.
- [Work Hours Compliance Monitor](../work-hours-compliance-monitor-by-timely/index.md) - Monitor employee time-tracking and labor law compliance.
