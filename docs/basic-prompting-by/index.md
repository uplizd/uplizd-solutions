...
## Demo
![Basic Prompting workflow interface showing Chat Input, Agent node, and Chat Output nodes](assets/image.png)
...
- [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) - Manage complex multi-step business process automations.
