...
## Demo
![Product Pricing Manager workflow interface showing Stripe product creation and price configuration nodes](assets/image.png)
...
* [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) — Streamline customer onboarding and CRM record creation.
* [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) — Manage complex operational tasks across business platforms.
