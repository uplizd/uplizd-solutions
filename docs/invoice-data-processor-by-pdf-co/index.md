...
## Demo
![Invoice Data Processor workflow interface showing PDF extraction and CRM data mapping](assets/image.png)
...
* [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) — Streamline the creation of new accounts and records in your CRM.
* [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) — Orchestrate complex multi-step business processes across your tech stack.
