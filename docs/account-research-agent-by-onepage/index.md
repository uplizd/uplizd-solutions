...
## Demo
![Account Research Agent workflow diagram showing data ingestion from OnePage CRM and AI-driven report generation](assets/image.png)
...
## Related Solutions
- [Account Intelligence Gatherer](../account-intelligence-gatherer-by-dropcontact/index.md) — Enrich account profiles with external firmographic data.
- [Account Relationship Builder](../account-relationship-builder-by-dynamics365/index.md) — Map and manage complex stakeholder relationships within your CRM.
- [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) — Automate the creation and configuration of new accounts in your CRM.
