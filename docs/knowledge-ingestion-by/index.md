...
## Demo
![Knowledge Ingestion workflow showing web URL input, AI parsing node, and knowledge base storage](assets/image.png)
...
- [YouTube Insight Agent](../you-tube-insight-agent-by/index.md) — Extract and analyze insights from video content.
