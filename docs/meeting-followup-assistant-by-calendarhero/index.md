...
## Demo
![Meeting Follow-up Assistant workflow diagram showing calendar integration and automated email dispatch](assets/image.png)
...
## Related Solutions
- [Deal Pipeline Manager](../deal-pipeline-manager/index.md) - Manage sales stages and follow-ups to maintain pipeline velocity.
- [Deal Opportunity Tracker](../deal-opportunity-tracker/index.md) - Identify and score opportunities based on meeting signals and lead data.
- [CRM Data Sync Agent](../crm-data-sync-agent/index.md) - Synchronize data across platforms to ensure consistent meeting records.
