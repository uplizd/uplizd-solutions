...
## Demo
![HR Onboarding Document Agent workflow showing automated document generation and SignWell integration](assets/image.png)
...
## Related Solutions
* [Workforce Onboarding Automator](../workforce-onboarding-automator-by-connecteam/index.md) — Manage employee onboarding tasks and team communication.
* [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) — Automate account creation and configuration for new users.
