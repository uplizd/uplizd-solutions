...
## Demo
![Pack Publishing Assistant workflow interface showing automated Coda pack deployment steps](assets/image.png)
...
* [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) - Streamlines CRM account configuration and onboarding.
* [Workspace Usage Analyzer](../workspace-usage-analyzer-by-baserow/index.md) - Monitors and reports on platform usage metrics.
