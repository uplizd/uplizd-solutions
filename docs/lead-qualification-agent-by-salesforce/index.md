...
## Demo
![Lead Qualification Agent workflow diagram showing Chat Input, Agent, Composio Salesforce Toolset, and Chat Output nodes](assets/image.png)
...
- [CRM Data Hygiene Manager](../crm-data-hygiene-manager/index.md) — Automate data cleanup and formatting for your CRM records.
- [Deal Pipeline Manager](../deal-pipeline-manager/index.md) — Manage deal stages and follow-up cadences for active opportunities.
- [Account Research Assistant](../account-research-assistant-by-zoominfo/index.md) — Enrich account data to support better lead qualification.
