...
## Demo
![Employee Onboarding Assistant workflow diagram showing Chat Input, Agent, Composio Toolset, and Chat Output nodes](assets/image.png)
...
## Related Solutions
- [Workforce Onboarding Automator](../workforce-onboarding-automator-by-connecteam/index.md) - Automates broader workforce management and onboarding tasks.
- [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) - Manages CRM account creation and user provisioning.
- [Admin User Onboarding Assistant](../admin-user-onboarding-assistant-by-storeganise/index.md) - Streamlines administrative user access and onboarding.
