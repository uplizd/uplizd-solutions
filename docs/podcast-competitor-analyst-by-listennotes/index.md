...
## Demo
![Podcast Competitor Analyst workflow showing ListenNotes integration and AI analysis nodes](assets/image.png)
...
- [Account Intelligence Reporter](../account-intelligence-reporter-by-leadfeeder/index.md) — Gather deep insights on target accounts and market positioning.
- [YouTube Audience Research Agent](../you-tube-audience-research-agent-by-youtube/index.md) — Understand viewer sentiment and audience preferences for content strategy.
