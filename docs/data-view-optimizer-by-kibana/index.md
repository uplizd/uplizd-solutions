...
## Demo
![Data View Optimizer workflow interface showing Kibana integration nodes and automated optimization logic](assets/image.png)
...
- [Workspace Usage Analyzer](../workspace-usage-analyzer-by-baserow/index.md) - Analyze and optimize data usage patterns across your workspace.
