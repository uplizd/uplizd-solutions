...
## Demo
![Store Locator Manager workflow dashboard showing data synchronization and access control nodes](assets/image.png)
...
## Related Solutions
- [Account Setup Agent by Salesforce](../account-setup-agent-by-salesforce/index.md) - Automate CRM account creation and configuration.
- [Admin User Onboarding Assistant by Storeganise](../admin-user-onboarding-assistant-by-storeganise/index.md) - Streamline user access and onboarding for store management platforms.
- [Workflow Automation Agent by Jobnimbus](../workflow-automation-agent-by-jobnimbus/index.md) - Extend operational automation to broader business workflows.
