...
## Demo
![User Behavior Anomaly Detector workflow showing data ingestion from Microsoft Clarity, AI analysis, and alert routing](assets/image.png)
...
## Related Solutions
* [AB Test Performance Analyzer (Microsoft Clarity)](../ab-test-performance-analyzer-by-microsoft-clarity/index.md) - Analyze A/B test results using session data.
* [Account Health Usage Monitor (Jotform)](../account-health-usage-monitor-by-jotform/index.md) - Track user engagement and account health metrics.
* [Workflow Health Monitor (DailyBot)](../workflow-health-monitor-by-dailybot/index.md) - Monitor the operational health of automated business processes.
