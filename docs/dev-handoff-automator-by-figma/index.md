...
## Demo
![Dev Handoff Automator workflow showing Figma design extraction and code generation](assets/image.png)
...
## Related Solutions
- [Accessibility Audit Assistant](../accessibility-audit-assistant-by-figma/index.md) — Automates accessibility compliance checks for design files.
- [Workshop Template Curator](../workshop-template-curator-by-miro/index.md) — Manages and deploys design workshop templates.
