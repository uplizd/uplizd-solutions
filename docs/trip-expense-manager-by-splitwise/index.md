...
## Demo
![Uplizd Trip Expense Manager workflow showing Splitwise integration for automated group travel cost splitting](assets/image.png)
...
- [Workspace Setup Optimizer](../workspace-setup-optimizer-by-clockify/index.md) - Manage time and resource allocation for team environments.
