...
## Demo
![Sales Pipeline Tracker workflow diagram showing CRM data flowing into Google Sheets via Uplizd](assets/image.png)
...
- [Deal Pipeline Manager](../deal-pipeline-manager/index.md) - Manages pipeline stages and identifies stalled opportunities.
- [CRM Data Sync Agent](../crm-data-sync-agent/index.md) - Synchronizes data between multiple CRM platforms and external databases.
