...
## Demo
![Customer Feedback Intelligence Agent workflow showing text input, TextRazor analysis, and structured output](assets/image.png)
...
- [whats-app-support-triage-agent-by-wati](../whats-app-support-triage-agent-by-wati/index.md) - Intelligent triage for WhatsApp-based customer support requests.
- [account-intelligence-reporter-by-leadfeeder](../account-intelligence-reporter-by-leadfeeder/index.md) - Automated reporting for account-level intelligence and insights.
