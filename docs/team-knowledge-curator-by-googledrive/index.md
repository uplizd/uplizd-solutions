...
## Demo
![Team Knowledge Curator workflow interface showing Google Drive integration and AI-powered document retrieval](assets/image.png)
...
## Related Solutions
- [Workshop Template Curator (Miro)](../workshop-template-curator-by-miro/index.md) — Organize and retrieve collaborative workshop assets.
- [Account Research Assistant (ZoomInfo)](../account-research-assistant-by-zoominfo/index.md) — Gather external account intelligence to complement internal knowledge.
- [Workflow Health Monitor (DailyBot)](../workflow-health-monitor-by-dailybot/index.md) — Track the efficiency of internal team processes.
