...
## Demo
![Expense Receipt Tracker workflow showing receipt upload, AI extraction, and data sync to accounting software](assets/image.png)
...
- [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) - Streamline cross-platform operational tasks and data handoffs.
- [Account Health Usage Monitor](../account-health-usage-monitor-by-jotform/index.md) - Track and report on account activity and resource utilization metrics.
