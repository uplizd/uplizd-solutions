...
## Demo
![New User Onboarding Assistant workflow showing Chat Input, Agent, Salesmate Composio Toolset, and Chat Output nodes](assets/image.png)
...
## Related Solutions
* [Account Setup Agent (Salesforce)](../account-setup-agent-by-salesforce/index.md) - Automates user provisioning and CRM configuration for Salesforce environments.
* [Workforce Onboarding Automator (Connecteam)](../workforce-onboarding-automator-by-connecteam/index.md) - Streamlines general employee onboarding and internal communications.
* [Admin User Onboarding Assistant (Storeganise)](../admin-user-onboarding-assistant-by-storeganise/index.md) - Specialized onboarding flow for administrative roles in Storeganise.
