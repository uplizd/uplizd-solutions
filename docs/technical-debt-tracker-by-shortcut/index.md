...
## Demo
![Technical Debt Tracker workflow interface showing Shortcut integration and automated ticket creation](assets/image.png)
...
## Related Solutions
* [Action Item Prioritizer (Rootly)](../action-item-prioritizer-by-rootly/index.md) — Streamline the prioritization of operational action items.
* [Action Item Cleanup Agent (Rootly)](../action-item-cleanup-agent-by-rootly/index.md) — Automate the resolution and archiving of stale action items.
* [Workflow Health Monitor (DailyBot)](../workflow-health-monitor-by-dailybot/index.md) — Track the overall health and velocity of your development workflows.
