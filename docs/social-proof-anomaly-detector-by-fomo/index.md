...
## Demo
![Social Proof Anomaly Detector workflow visualizing event stream analysis and alert triggers](assets/image.png)
...
## Related Solutions
- [Abandoned Cart Recovery Agent](../abandoned-cart-recovery-agent-by-klaviyo/index.md) - Automates follow-ups for high-intent users who leave the site.
- [Account Health Usage Monitor](../account-health-usage-monitor-by-jotform/index.md) - Tracks user engagement metrics to identify at-risk accounts.
- [Workflow Health Monitor](../workflow-health-monitor-by-dailybot/index.md) - Keeps your automated processes running smoothly by monitoring for execution errors.
