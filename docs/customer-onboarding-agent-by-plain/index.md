...
## Demo
![Customer Onboarding Agent workflow diagram showing Chat Input, Agent, Plain Composio Toolset, and Chat Output nodes](assets/image.png)
...
* [account-setup-agent-by-salesforce](../account-setup-agent-by-salesforce/index.md) - Automate account creation within Salesforce.
