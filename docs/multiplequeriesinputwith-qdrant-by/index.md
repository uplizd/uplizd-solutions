...
## Demo
![Workflow diagram showing multiple user queries being processed through an Agent node and the Composio Toolset to retrieve data from Qdrant](assets/image.png)
...
- [CRM Data Sync Agent](../crm-data-sync-agent/index.md) - Synchronizes data across platforms with conflict resolution.
