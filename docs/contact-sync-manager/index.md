# Contact Sync Manager (Uplizd) - Synchronize Team Data & Membership

## Summary
The Contact Sync Manager is an Uplizd AI workflow designed to maintain accurate team contact information across Chatwork platforms. By automating the baseline of team membership and monitoring participation across all project rooms, this solution ensures your organizational directory remains a single source of truth, improving pipeline velocity and data hygiene for operations teams.

---

## Demo

![Uplizd Contact Sync Manager flow synchronizing team contact data and identifying membership changes](assets/image.png)

**Alt text (SEO-ready):** Uplizd Contact Sync Manager integrating Chatwork toolsets to automate team contact synchronization, membership reporting, and data hygiene workflows.
...
**Secondary tags**: chatwork, contact sync, team management, membership, data hygiene, composio, ai workflow, directory management

This solution bridges the gap between fragmented communication channels and centralized team data, ensuring your directory reflects real-time collaboration.
...
- **HR & People Ops**
    - Track team growth, departures, and internal moves across various project channels.
- **IT Administrators**
...
- Automatically flag departed members for removal from the master contact list.
...
- Understand how team dynamics change as projects evolve over time.
...
### 2) Setup the Nodes
- **Chat Input** → Receives natural language commands for synchronization or reporting.
- **Agent** → Interprets room and membership data to identify changes and infer roles.
- **Composio Toolset** → Provides the primary API calls for contact and room data retrieval.
- **Chat Output** → Displays the final sync report and identified changes to the user.
...
* **[CRM Data Sync Manager](../crm-data-sync-manager/index.md)**  
  Orchestrate and monitor data flows across your entire enterprise tech stack.

* **[Deal Pipeline Manager](../deal-pipeline-manager/index.md)**  
  Automatically update deal progress and create follow-up tasks for your sales team.

* **[CRM Address Data Cleanup Agent](../crm-address-data-cleanup-agent/index.md)**  
