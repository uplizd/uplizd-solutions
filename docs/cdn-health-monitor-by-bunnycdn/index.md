...
## Demo
![CDN Health Monitor dashboard showing real-time latency and cache hit ratio metrics](assets/image.png)
...
- [Workflow Health Monitor](../workflow-health-monitor-by-dailybot/index.md) — Automated tracking of internal workflow performance and team productivity.
- [Zone Provisioning Agent](../zone-provisioning-agent-by-cloudflare/index.md) — Automates the setup and configuration of new CDN zones and security policies.
