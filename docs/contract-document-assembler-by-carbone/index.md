...
## Demo
![Contract Document Assembler workflow interface showing data mapping from CRM to Carbone templates](assets/image.png)
...
## Related Solutions
- [Account Research Agent](../account-research-agent-by-onepage/index.md) — Automate deep-dive research into accounts to prepare for contract negotiations.
- [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) — Streamline the creation of new CRM records to feed into your document assembly workflows.
- [Deal Pipeline Manager](../deal-pipeline-manager/index.md) — Manage the stages of your deals to ensure documents are generated at the right time.
- [CRM Data Hygiene Manager](../crm-data-hygiene-manager/index.md) — Clean your CRM data before assembly to ensure contracts are generated with accurate information.
