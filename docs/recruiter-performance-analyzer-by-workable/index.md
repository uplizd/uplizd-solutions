...
## Demo
![Recruiter Performance Analyzer dashboard showing recruiter metrics and hiring pipeline stages](assets/image.png)
...
- [Account Research Agent](../account-research-agent-by-onepage/index.md) - Gather deep intelligence on target hiring accounts.
