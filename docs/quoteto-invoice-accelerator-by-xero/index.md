...
## Demo
![Quote to Invoice Accelerator workflow showing the transition from sales quote data to Xero invoice generation](assets/image.png)
...
* [Deal Pipeline Manager](../deal-pipeline-manager/index.md) — Manage sales stages and deal progression.
