...
## Demo
![Code Quality Monitor dashboard showing real-time technical debt and security alerts from Codacy](assets/image.png)
...
- [Workflow Health Monitor](../workflow-health-monitor-by-dailybot/index.md) - Real-time tracking and alerting for team workflow performance.
- [Admin User Access Auditor](../admin-user-access-auditor-by-storeganise/index.md) - Monitoring and auditing user permissions and access logs.
