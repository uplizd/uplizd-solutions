...
## Demo
![Project Health Monitoring Agent dashboard showing task status and bottleneck alerts](assets/image.png)
...
## Related Solutions
*   [Workflow Health Monitor](../workflow-health-monitor-by-dailybot/index.md) - Track general workflow efficiency and team productivity.
*   [Action Item Prioritizer](../action-item-prioritizer-by-rootly/index.md) - Focus on sorting and managing urgent action items.
*   [Action Item Cleanup Agent](../action-item-cleanup-agent-by-rootly/index.md) - Automate the maintenance and hygiene of project action items.
