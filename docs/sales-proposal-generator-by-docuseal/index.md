...
## Demo
![Sales Proposal Generator workflow showing Chat Input, Agent, DocuSeal Toolset, and Chat Output nodes](assets/image.png)
...
- [Deal Pipeline Manager](../deal-pipeline-manager/index.md) — Track and manage sales opportunities through custom pipeline stages.
- [CRM Data Hygiene Manager](../crm-data-hygiene-manager/index.md) — Clean and standardize CRM data to ensure accurate proposal generation.
