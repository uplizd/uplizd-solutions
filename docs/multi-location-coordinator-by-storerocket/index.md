...
## Demo
![Multi-Location Coordinator workflow showing Chat Input, Agent node, Composio Toolset, and Chat Output for store data management](assets/image.png)
...
## Related Solutions
* [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) - Automates the onboarding and configuration of new accounts.
