...
## Demo
![Sales Call Analyzer workflow showing transcription, sentiment analysis, and CRM update nodes](assets/image.png)
...
## Related Solutions
- [Deal Pipeline Manager](../deal-pipeline-manager/index.md) - Manage sales stages and follow-ups to keep deals moving.
