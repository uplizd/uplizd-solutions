...
## Demo
![Data Analysis Automator workflow interface showing raw data input, code execution, and visualization output](assets/image.png)
...
## Related Solutions
*   [Account Intelligence Reporter](../account-intelligence-reporter-by-leadfeeder/index.md) — Generate comprehensive reports on account health and engagement.
