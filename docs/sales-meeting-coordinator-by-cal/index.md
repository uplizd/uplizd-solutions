...
## Demo
![Sales Meeting Coordinator workflow interface showing automated calendar scheduling and CRM integration steps](assets/image.png)
...
## Related Solutions
- [Account Research Agent](../account-research-agent-by-onepage/index.md) — Automate prospect intelligence gathering before meetings.
- [Deal Pipeline Manager](../deal-pipeline-manager/index.md) — Manage deal stages and pipeline velocity after the meeting is booked.
- [CRM Data Sync Agent](../crm-data-sync-agent/index.md) — Ensure prospect data remains consistent across platforms.
