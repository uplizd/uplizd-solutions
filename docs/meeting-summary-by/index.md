...
## Demo
![Meeting Summary Agent workflow interface showing transcription and summary generation](assets/image.png)
...
- [Account Research Assistant](../account-research-assistant-by-zoominfo/index.md) — Enrich your meeting context with deep account intelligence.
- [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) — Automate downstream processes based on meeting outcomes.
