...
## Demo
![Account Relationship Builder workflow diagram showing Dynamics 365 integration and automated data enrichment](assets/image.png)
...
- [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) — Streamline the creation of new account profiles in your CRM.
- [Deal Pipeline Manager](../deal-pipeline-manager/index.md) — Track and manage deal stages and opportunity health.
