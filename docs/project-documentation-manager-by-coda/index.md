...
## Demo
![Project Documentation Manager workflow interface showing automated Coda sync](assets/image.png)
...
## Related Solutions
*   [Account Mapping Agent](../account-mapping-agent-by-bigpicture-io/index.md) — Automate the mapping of complex account structures.
...
*   [Workshop Template Curator](../workshop-template-curator-by-miro/index.md) — Manage and organize workshop templates for project planning.
