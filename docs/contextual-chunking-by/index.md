...
## Demo
![Contextual Chunking workflow showing document ingestion, context generation, and chunk embedding](assets/image.png)
...
- [Deal Pipeline Manager](../deal-pipeline-manager/index.md) - Manage and track deal stages for sales operations.
