...
## Demo
![Smart Time-Off Assistant workflow showing chat input, balance check, and approval routing](assets/image.png)
...
## Related Solutions
* [Workforce Onboarding Automator](../workforce-onboarding-automator/index.md) - Streamline new hire documentation and system access.
* [Work Hours Compliance Monitor](../work-hours-compliance-monitor-by-timely/index.md) - Track employee work hours and ensure labor regulation compliance.
* [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) - Automate the creation and configuration of new user accounts.
