...
## Demo
![Uplizd AI workflow dashboard showing Moosend campaign performance analytics and optimization suggestions](assets/image.png)
...
## 🚀 Run on Uplizd
[![Run on Uplizd](https://img.shields.io/badge/Run%20on-Uplizd-blue?logo=uplizd)](https://uplizd.ai/solutions/a1624457-9db5-513c-b0a1-e921503b6ef5)
...
## Related Solutions
- [Abandoned Cart Recovery Agent](../abandoned-cart-recovery-agent-by-klaviyo/index.md) — Automate recovery sequences for lost sales.
...
- [Affiliate Performance Monitor](../affiliate-performance-monitor-by-tapfiliate/index.md) — Track and optimize affiliate marketing channel performance.
