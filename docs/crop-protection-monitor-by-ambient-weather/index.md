...
## Demo
![Crop Protection Monitor workflow dashboard showing weather data integration and automated alert triggers](assets/image.png)
...
* [Account Audit Agent](../account-audit-agent-by-cloudflare/index.md) - Perform comprehensive audits on account configurations and security.
