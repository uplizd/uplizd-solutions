...
## Demo
![Customer Health Dashboard Agent workflow showing NPS data integration and feedback analysis](assets/image.png)
...
## Related Solutions
- [Account Health Usage Monitor](../account-health-usage-monitor-by-jotform/index.md) — Tracks product usage metrics to complement NPS data.
- [Account Intelligence Reporter](../account-intelligence-reporter-by-leadfeeder/index.md) — Enriches account data with external intent signals.
- [CRM Data Sync Agent](../crm-data-sync-agent/index.md) — Synchronizes customer data across disparate platforms to ensure consistency.
- [Deal Pipeline Manager](../deal-pipeline-manager/index.md) — Manages sales opportunities and deal stages alongside account health.
