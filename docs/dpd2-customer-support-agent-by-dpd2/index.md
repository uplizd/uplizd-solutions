...
## Demo
![DPD2 Customer Support Agent workflow interface showing automated query resolution and data retrieval](assets/image.png)
...
* [whats-app-order-status-agent-by-wati](../whats-app-order-status-agent-by-wati/index.md) - Automated order status tracking via WhatsApp.
