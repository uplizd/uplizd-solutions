...
## Demo
![Uplizd AI workflow for tracking candidate background check status in Workable](assets/image.png)
...
- [Workforce Onboarding Automator](../workforce-onboarding-automator-by-connecteam/index.md) - Streamline the transition from candidate to employee.
- [Admin User Onboarding Assistant](../admin-user-onboarding-assistant-by-storeganise/index.md) - Manage new user access and permissions systematically.
