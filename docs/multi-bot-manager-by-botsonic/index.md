...
## Demo
![Multi-Bot Manager workflow dashboard showing centralized chatbot status and configuration nodes](assets/image.png)
...
## Related Solutions
- [247-customer-support-chatbot-by-botstar](../247-customer-support-chatbot-by-botstar/index.md) — Manage individual support bot instances.
...
- [account-setup-agent-by-salesforce](../account-setup-agent-by-salesforce/index.md) — Automate the onboarding of new accounts and bot users.
