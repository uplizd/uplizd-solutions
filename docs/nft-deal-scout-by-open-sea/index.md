...
## Demo
![NFT Deal Scout dashboard showing real-time OpenSea asset monitoring and price analysis](assets/image.png)
...
- [Account Research Agent](../account-research-agent-by-onepage/index.md) — Deep-dive research for high-value sales targets.
