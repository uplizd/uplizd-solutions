...
## Demo
![Sales Performance Analyzer dashboard showing CRM pipeline health and revenue forecasting metrics](assets/image.png)
...
## Related Solutions
* [Deal Pipeline Manager](../deal-pipeline-manager/index.md) — Manage pipeline stages and automate follow-up tasks.
...
* [CRM Data Hygiene Manager](../crm-data-hygiene-manager/index.md) — Maintain clean and accurate CRM records.
