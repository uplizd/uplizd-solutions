...
## Demo
![Automated Sales Dashboard with Google Sheets workflow showing CRM data syncing to a spreadsheet](assets/image.png)
...
- [CRM Data Sync Agent](../crm-data-sync-agent/index.md) - Facilitates multi-platform data synchronization and conflict resolution.
- [Deal Pipeline Manager](../deal-pipeline-manager/index.md) - Manages pipeline stages and automates follow-up actions for sales teams.
