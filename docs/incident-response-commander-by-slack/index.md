...
## Demo
![Incident Response Commander workflow showing Slack integration for automated incident triage and task assignment](assets/image.png)
...
## Related Solutions
- [Action Item Cleanup Agent](../action-item-cleanup-agent-by-rootly/index.md) - Automates the resolution and cleanup of incident-related tasks.
- [Action Item Prioritizer](../action-item-prioritizer-by-rootly/index.md) - Ranks and assigns incident follow-ups based on urgency.
- [Workflow Health Monitor](../workflow-health-monitor-by-dailybot/index.md) - Tracks the operational status and health of automated response workflows.
