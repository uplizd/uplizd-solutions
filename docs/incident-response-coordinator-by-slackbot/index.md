...
## Demo
![Incident Response Coordinator workflow showing Slack alert automation and team coordination](assets/image.png)
...
## Related Solutions
- [Action Item Cleanup Agent](../action-item-cleanup-agent-by-rootly/index.md) — Automates the organization and resolution of post-incident action items.
- [Action Item Prioritizer](../action-item-prioritizer-by-rootly/index.md) — Ranks and assigns tasks based on incident severity and team capacity.
- [Workflow Health Monitor](../workflow-health-monitor-by-dailybot/index.md) — Tracks the overall status and performance of automated team workflows.
