...
## Demo
![Customer List Sync Manager workflow showing CRM data flowing into Google Ads via Uplizd](assets/image.png)
...
## Related Solutions
- [Account Intelligence Gatherer](../account-intelligence-gatherer-by-dropcontact/index.md) - Enrich CRM accounts with verified contact data.
- [CRM Data Sync Agent](../crm-data-sync-agent/index.md) - General-purpose synchronization between multiple CRM and business platforms.
- [Deal Opportunity Tracker](../deal-opportunity-tracker-by-salesforce/index.md) - Monitor and score sales opportunities for pipeline management.
