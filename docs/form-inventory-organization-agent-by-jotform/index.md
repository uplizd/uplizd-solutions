...
## Demo
![Form Inventory & Organization Agent dashboard showing automated form categorization and library cleanup status](assets/image.png)
...
## Related Solutions
- [Account Health Usage Monitor](../account-health-usage-monitor-by-jotform/index.md) — Monitor and track account usage metrics across Jotform assets.
