...
## Demo
![Meeting Intelligence Agent workflow dashboard showing audio processing, transcription, and action item extraction nodes](assets/image.png)
...
* [Action Item Prioritizer](../action-item-prioritizer-by-rootly/index.md) - Organize and rank tasks extracted from various sources.
