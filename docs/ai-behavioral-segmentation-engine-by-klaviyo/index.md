...
## Demo
![AI Behavioral Segmentation Engine workflow diagram showing data flow from Klaviyo through the Uplizd agent to segment output](assets/image.png)
...
## Related Solutions
*   [Abandoned Cart Recovery Agent](../abandoned-cart-recovery-agent-by-klaviyo/index.md) — Automate recovery flows for users who leave items in their cart.
