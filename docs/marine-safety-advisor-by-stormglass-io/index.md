...
## Demo
![Marine Safety Advisor dashboard showing real-time weather risk assessment and vessel safety alerts](assets/image.png)
...
- [Account Health Compliance Monitor](../account-health-compliance-monitor-by-brevo/index.md) - Automated tracking of compliance and health status for business operations.
- [Workflow Health Monitor](../workflow-health-monitor-by-dailybot/index.md) - Real-time oversight for maintaining operational efficiency and system integrity.
