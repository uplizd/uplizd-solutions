...
## Demo
![Contract Document Processor workflow interface showing data extraction and PDF generation nodes](assets/image.png)
...
## Related Solutions
*   [Account Research Agent](../account-research-agent-by-onepage/index.md) — Automates the gathering of account intelligence for contract preparation.
*   [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) — Streamlines the creation of new accounts in your CRM to feed contract data.
*   [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) — Manages broader operational workflows that trigger document generation.
