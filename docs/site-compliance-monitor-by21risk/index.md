...
## Demo
![Site Compliance Monitor workflow dashboard showing automated audit logs and risk alerts](assets/image.png)
...
- [Account Health Compliance Monitor](../account-health-compliance-monitor-by-brevo/index.md) - Tracking account-level compliance and usage health.
- [Workplace Risk Early Warning System](../workplace-risk-early-warning-system-by-faceup/index.md) - Proactive identification of organizational risk factors.
