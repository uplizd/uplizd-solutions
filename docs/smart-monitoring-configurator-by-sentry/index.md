...
## Demo
![Smart Monitoring Configurator workflow showing automated Sentry rule deployment and pattern analysis](assets/image.png)
...
* [Workflow Health Monitor](../workflow-health-monitor-by-dailybot/index.md) — Tracks the operational status and performance of automated pipelines.
* [Zone Provisioning Agent](../zone-provisioning-agent-by-cloudflare/index.md) — Manages network infrastructure setup and configuration at scale.
