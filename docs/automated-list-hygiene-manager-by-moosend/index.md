...
## Demo
![Automated List Hygiene Manager workflow showing Moosend integration and data cleaning nodes](assets/image.png)
...
## Related Solutions
- [Abandoned Cart Recovery Agent](../abandoned-cart-recovery-agent-by-klaviyo/index.md) - Recovers lost revenue by automating follow-ups for abandoned carts.
- [CRM Data Hygiene Manager](../crm-data-hygiene-manager/index.md) - General purpose tool for cleaning and deduplicating CRM contact data.
- [WhatsApp Lead Nurturing Agent](../whats-app-lead-nurturing-agent-by-spoki/index.md) - Engages leads via WhatsApp to keep contact lists active and responsive.
