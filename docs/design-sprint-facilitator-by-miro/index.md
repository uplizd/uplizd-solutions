...
## Demo
![Design Sprint Facilitator workflow showing Miro board automation and session management nodes](assets/image.png)
...
## Related Solutions
- [Workshop Template Curator](../workshop-template-curator-by-miro/index.md) - Automate the selection and deployment of workshop templates.
- [Workshop Facilitator Agent](../workshop-facilitator-agent-by-mural/index.md) - Manage collaborative sessions specifically within Mural environments.
- [Account Research Agent](../account-research-agent-by-onepage/index.md) - Gather intelligence to inform design sprint participant lists.
