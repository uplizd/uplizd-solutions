...
## Demo
![Zoom Usage Intelligence Agent dashboard showing meeting analytics and participant engagement metrics](assets/image.png)
...
## Related Solutions
- [Workspace Usage Analyzer](../workspace-usage-analyzer-by-baserow/index.md) - Track and optimize workspace resource utilization.
- [Workflow Health Monitor](../workflow-health-monitor-by-dailybot/index.md) - Monitor the efficiency and status of team workflows.
- [Account Health Usage Monitor](../account-health-usage-monitor-by-jotform/index.md) - Track account engagement and health metrics.
