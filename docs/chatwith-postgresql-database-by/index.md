...
## Demo
![Chat with PostgreSQL Database interface showing natural language query execution and data output](assets/image.png)
...
- [Workflow Health Monitor](../workflow-health-monitor-by-dailybot/index.md) — Track the status and performance of automated business processes.
- [Workspace Usage Analyzer](../workspace-usage-analyzer-by-baserow/index.md) — Gain insights into database and workspace activity patterns.
