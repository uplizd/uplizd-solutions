...
## Demo
![Meeting Task Generator workflow showing transcript input, AI extraction, and Todoist task creation](assets/image.png)
...
## Related Solutions
- [Action Item Cleanup Agent](../action-item-cleanup-agent-by-rootly/index.md) - Manage and resolve stale action items across your organization.
- [Action Item Prioritizer](../action-item-prioritizer-by-rootly/index.md) - Automatically rank and prioritize tasks based on urgency and impact.
