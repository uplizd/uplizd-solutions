...
## Demo
![Project Status Tracker workflow showing Slack integration and automated status updates](assets/image.png)
...
* [Action Item Cleanup Agent](../action-item-cleanup-agent-by-rootly/index.md) - Maintain clean project logs by archiving or resolving stale action items.
