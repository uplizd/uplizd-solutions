...
## Demo
![Customer Renewal Documentation Agent workflow screenshot showing DocuSign integration and automated document generation](assets/image.png)
...
## Related Solutions
- [Account Research Agent](../account-research-agent-by-onepage/index.md) — Automate deep-dive research into customer accounts.
- [Account Health Usage Monitor](../account-health-usage-monitor-by-jotform/index.md) — Track customer usage metrics to trigger renewal workflows.
- [Account Relationship Builder](../account-relationship-builder-by-dynamics365/index.md) — Manage complex stakeholder relationships for enterprise renewals.
