...
## Demo
![Linear issue status synchronization workflow showing automated state transitions triggered by external events](assets/image.png)
...
* [Action Item Cleanup Agent](../action-item-cleanup-agent-by-rootly/index.md) - Manage and archive stale action items across your stack.
* [Workflow Health Monitor](../workflow-health-monitor-by-dailybot/index.md) - Track the efficiency and status of your team's operational workflows.
