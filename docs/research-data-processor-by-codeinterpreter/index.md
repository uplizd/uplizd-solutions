...
## Demo
![Research Data Processor workflow interface showing data ingestion, cleaning, and analysis nodes](assets/image.png)
...
* [Account Intelligence Reporter](../account-intelligence-reporter-by-leadfeeder/index.md) - Generates comprehensive reports on account activity and health.
* [CRM Data Hygiene Manager](../crm-data-hygiene-manager/index.md) - Maintains data quality and consistency across CRM platforms.
