...
## Demo
![Appointment Booking Assistant workflow diagram showing Chat Input connected to an Agent, Composio Toolset, and Chat Output](assets/image.png)
...
*   [account-setup-agent-by-salesforce](../account-setup-agent-by-salesforce/index.md) - Streamlining new account onboarding and data entry.
*   [whats-app-lead-qualification-agent-by-whatsapp](../whats-app-lead-qualification-agent-by-whatsapp/index.md) - Qualifying leads via messaging platforms.
