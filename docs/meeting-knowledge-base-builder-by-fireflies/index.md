...
## Demo
![Meeting Knowledge Base Builder workflow diagram showing transcript ingestion from Fireflies.ai into a searchable knowledge base](assets/image.png)
...
## Related Solutions
- [Action Item Prioritizer](../action-item-prioritizer-by-rootly/index.md) - Automatically rank and assign tasks extracted from meetings.
- [Account Research Assistant](../account-research-assistant-by-zoominfo/index.md) - Enrich your meeting context with external account intelligence.
- [Workflow Automation Agent](../workflow-automation-agent-by-jobnimbus/index.md) - Trigger downstream tasks based on meeting outcomes.
