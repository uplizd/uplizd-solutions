...
## Demo
![Incident Command Center dashboard showing automated Sentry alert triage and team notification workflow](assets/image.png)
...
## Related Solutions
- [Action Item Cleanup Agent](../action-item-cleanup-agent-by-rootly/index.md) — Automates the cleanup and organization of post-incident action items.
- [Action Item Prioritizer](../action-item-prioritizer-by-rootly/index.md) — Uses AI to rank and assign incident-related tasks based on urgency.
- [Workflow Health Monitor](../workflow-health-monitor-by-dailybot/index.md) — Tracks the overall health and execution status of automated operational workflows.
