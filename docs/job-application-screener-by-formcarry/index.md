...
## Demo
![Job Application Screener workflow interface showing form submission, AI qualification, and scheduling nodes](assets/image.png)
...
- [Account Setup Agent](../account-setup-agent-by-salesforce/index.md) - Streamline the onboarding process for new accounts in Salesforce.
