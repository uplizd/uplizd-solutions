...
## Demo
![Lead Intake Processor workflow showing automated lead qualification and Pipedrive CRM synchronization](assets/image.png)
...
- [Deal Pipeline Manager](../deal-pipeline-manager/index.md) — Manage and track deal progression through sales stages.
- [CRM Data Hygiene Manager](../crm-data-hygiene-manager/index.md) — Maintain clean and accurate CRM records automatically.
